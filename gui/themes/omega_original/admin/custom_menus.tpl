                    ...
                    <tr>
                      <td><table width="100%" cellpadding="5" cellspacing="5">
                          ...
                          <tr>
                            ...
                            <td width="100" class="{CONTENT}" align="center"><img src="{THEME_COLOR_PATH}/images/icons/delete.png" width="16" height="16" border="0" align="absmiddle"> <a href="custom_menus.php?delete_id={BUTONN_ID}" onclick="return action_delete('custom_menus.php?delete_id={BUTONN_ID}', '{MENU_NAME2}')" class="link">{TR_DELETE}</a></td>
                          </tr>
                          <!-- EDP: button_list -->
                        </table>
                          <br>
