<?php
/* $Id: finnish-iso-8859-15.inc.php 9853 2007-01-19 18:14:44Z lem9 $ */
...
$strCreateUserDatabaseName = 'Luo saman niminen tietokanta ja anna kaikki oikeudet';
...
$strFileNameTemplateDescription = 'Tämä arvo on %1$sstrftime%2$s-funktion mukainen, joten voit käyttää ajanmuodostostukseen käytettäviä merkkijonoja. Lisäksi tapahtuu seuraavat muutokset: %3$s. Muu teksti pysyy alkuperäisenä.';
...
$strGo = 'Siirry';
$strGrantOption = 'Saantioikeus (Grant)';
...
$strRunQuery = 'Suorita';
$strRunSQLQueryOnServer = 'Suorita SQL-kysey(itä) palvelimella %s';
$strRunSQLQuery = 'Suorita SQL-kyselyitä tietokannassa %s';
...
$strShowStatusInnodb_buffer_pool_pages_flushedDescr = 'Siistittäviksi pyydettyjen, puskurisäiliössä olevien sivujen lukumäärä.';
...
$strShowStatusInnodb_buffer_pool_readsDescr = 'Loogisten lukukertojen määrä, joita InnoDB ei voinut toteuttaa puskurisäiliöstä, ja InnoDB joutui lukemaan yhden sivun kerrallaan.';
...
$strShowStatusInnodb_page_sizeDescr = 'InnoDB-sivun koko käännettynä (oletuksena 16KB). Useita arvoja lasketaan sivuina; sivun koko sallii niiden helpon muuttamisen tavuiksi.';
...
$strValidatorError = 'SQL-validaattoria ei voitu käynnistää. Tarkista, että olet asentanut tarpeelliset PHP-laajennukset. Lisätietoa löytyy %sdokumentaatiosta%s.';
$strValue = 'Arvo';
$strVar = 'Muuttuja';
