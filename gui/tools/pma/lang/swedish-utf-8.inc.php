<?php
/* $Id: swedish-utf-8.inc.php 11933 2008-11-21 16:47:05Z lem9 $ */
...
$strSetupServers_bookmarktable_desc = 'Lämna tomt för inget stöd för [a@http://wiki.cihar.com/pma/bookmark]bokmärken[/a], standard: [kbd]pma_bookmark[/kbd]';
...
$strSetupServers_controluser_desc = 'En speciell MySQL-användare konfigurerad med begränsade rättigheter, mer information tillgänglig på [a@http://wiki.cihar.com/pma/controluser]wiki[/a]';
...
$strSetupServers_pmadb_desc = 'Databas som används för relationer, bokmärken och PDF-funktioner. Se [a@http://wiki.cihar.com/pma/pmadb]pmadb[/a] för komplett information. Lämna tomt för utan stöd. Standard: [kbd]phpmyadmin[/kbd]';
...
$strSetupServers_relation_desc = 'Lämna tomt för inget stöd för [a@http://wiki.cihar.com/pma/relation]relationslänkar[/a], standard: [kbd]pma_relation[/kbd]';
...
$strSetupServers_SignonSession_desc = 'Se [a@http://wiki.cihar.com/pma/auth_types#signon]autentiseringstyper[/a] för ett exempel';
