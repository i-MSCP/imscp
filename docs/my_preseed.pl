...
%main::questions = (
    ...
    SERVER_HOSTNAME                     => 'srv01.nuxwin.com',

    # Primary server IP
    # Possible values: An already configured IPv4 or IPv6
    BASE_SERVER_IP                      => '192.168.1.133',
    ...
    BASE_SERVER_PUBLIC_IP               => '192.168.1.133',
    ...
    SERVER_IPS                          => [ '192.168.1.160', '192.168.1.161', '192.168.1.170', '192.198.1.171' ],
    ...
    BASE_SERVER_VHOST                   => 'panel.nuxwin.com',
    ...
    PHPMYADMIN_SQL_PASSWORD             => 'skittles',
