  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_sql.jpg" width="85" height="62" align="absmiddle">{TR_EXECUTE_SQL_QUERY}</td>
          ...
          <tr>
            ...
            <table width="100%" cellspacing="5">
              ...
              <tr> 
                ...
                <td class="content">
                  <textarea name="sql_query" cols="35" rows="5" wrap="virtual">{SQL_QUERY}</textarea>
                </td>
              </tr>
              <!-- BDP: sql_result -->
              <tr> 
              ...
              <tr> 
                <td colspan="2"> 
                  <input name="Submit" type="submit" class="button" value=" {TR_EXECUTE} ">                  </td>
              </tr>
            </table>
            <!-- end of content -->
