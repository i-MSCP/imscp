...
If you want connect to PhpMyAdmin to work on all databases, you should now use the i-MSCP master SQL user.
...
Starting with this new version, permissions on customer files are no longer set recursively by default. This allows to
