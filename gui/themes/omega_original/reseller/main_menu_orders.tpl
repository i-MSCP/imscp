...
<tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="orders.php" onmouseover="MM_swapImage('orders','','{THEME_COLOR_PATH}/images/icons/purchasing_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/purchasing_a.gif" name="orders" width="47" height="46" border="0" alt="" id="orders" /></a></div></td>
  </tr><tr>
