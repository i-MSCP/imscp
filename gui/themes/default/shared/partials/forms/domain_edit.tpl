				...
				<div style="margin:0" id="php_editor_dialog" title="{TR_PHP_EDITOR_SETTINGS}">
					...
					<table>
						...
						<tr>
							...
							<td>
								<input name="upload_max_filezize" id="upload_max_filezize" type="text" value="{UPLOAD_MAX_FILESIZE}">
								<span>{TR_MIB}</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<input name="max_execution_time" id="max_execution_time" type="text" value="{MAX_EXECUTION_TIME}">
								<span>{TR_SEC}</span>
							</td>
						</tr>
						<tr>
