...
$tpl->assign(
	array(
		...
		'ISP_LOGO' => layout_getUserLogo(),
                'TR_MENUPHPINI'                                 => tr('php.ini Settings'),
		        ...
		        'TR_PHP_INI_EXEC_HELP'                          => tr('if enabled, it allow the php function exec(). Needed from convert (imagemagic) and many image galleries')
