...
$tpl->assign(
	array(
		...
		'TR_PHPINI_ALLOW_URL_FOPEN' => tr('Value for the %s directive', '<b>allow_url_fopen</b>'),
		'TR_PHPINI_DISPLAY_ERRORS' => tr('Value for the %s directive', '<b>display_errors</b>'),
		'TR_PHPINI_ERROR_REPORTING' => tr('Value for the %s directive', '<b>error_reporting</b>'),
		...
		'TR_PHPINI_POST_MAX_SIZE' => tr('Value for the %s directive', '<b>post_max_size</b>'),
		'TR_PHPINI_UPLOAD_MAX_FILESIZE' => tr('Value for the %s directive', '<b>upload_max_filesize</b>'),
		'TR_PHPINI_MAX_EXECUTION_TIME' => tr('Value for the %s directive', '<b>max_execution_time</b>'),
		'TR_PHPINI_MAX_INPUT_TIME' => tr('Value for the %s directive', '<b>max_input_time</b>'),
		'TR_PHPINI_MEMORY_LIMIT' => tr('Value for the %s directive', '<b>memory_limit</b>'),
		'TR_PHPINI_OPEN_BASEDIR' => tr('Value for the %s directive', '<b>open_basedir</b>'),
		'TR_PHPINI_OPEN_BASEDIR_TOOLTIP' => tohtml(tr('Paths are appended to the default PHP open_basedir directive of customers. Each of them must be separated by PATH_SEPARATOR. See the PHP documentation for more information.'), 'htmlAttr'),
		'TR_PHPINI_DISABLE_FUNCTIONS' => tr('Value for the %s directive', '<b>disable_functions</b>'),
		'TR_MIB' => tr('MiB'),
		'TR_SEC' => tr('Sec.')
	)
);
