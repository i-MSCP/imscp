		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<a href="{URL_DELETE_ADMIN}" class="icon i_delete" onclick="action_delete('{ADMIN_USERNAME}')" class="link">{TR_DELETE}</a>
		...
		<table>
			...
			<tr>
				...
				<td>
					...
					<a href="{URL_DELETE_RSL}" class="icon i_delete" onclick="return action_delete('{RSL_USERNAME}')">{TR_DELETE}</a>
				</td>
			</tr>
			<!-- EDP: rsl_item -->
		</table>
			...
			<tr>
				<td>
					<a href="{URL_CHANGE_STATUS}" onclick="return action_status('{USR_USERNAME}')"
					   class="icon i_{STATUS}">{TR_STATUS}</a>
				</td>
				<td>
				...
				<td>
					...
					<!-- BDP: usr_delete_link -->
					<a class="icon i_delete" href="user_delete.php?user_id={USER_ID}">{TR_DELETE}</a>
					<!-- EDP: usr_delete_link -->
				</td>
			</tr>
			<!-- BDP: user_details -->
