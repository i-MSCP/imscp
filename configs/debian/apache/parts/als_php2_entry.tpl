    <IfModule mod_php5.c>
        php_admin_value open_basedir "{HOME_DIR}{MOUNT_POINT}:{HOME_DIR}{MOUNT_POINT}/phptmp/:{PEAR_DIR}/"
        php_admin_value upload_tmp_dir "{HOME_DIR}{MOUNT_POINT}/phptmp/"
        php_admin_value session.save_path "{HOME_DIR}{MOUNT_POINT}/phptmp/"
