...
<table border="0" cellspacing="2" cellpadding="2" style="margin-<?php echo __("left"); ?>: 20px;">
	<tr>
		...
		<td><input type="text" class="input" name="troubleshoot_ftpserver" value="<?php echo $net2ftp_globals["ftpserver"]; ?>" /></td>
	</tr>
	<tr>
		<td><?php echo __("FTP server port"); ?></td>
		<td><input type="text" class="input" size="3" maxlength="5" name="troubleshoot_ftpserverport" value="<?php echo $net2ftp_globals["ftpserverport"]; ?>" /></td>
	</tr>
	<tr>
		<td><?php echo __("Username"); ?></td>
		<td><input type="text" class="input" name="troubleshoot_username" value="<?php echo $net2ftp_globals["username"]; ?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" class="input" name="troubleshoot_directory" value="<?php echo $net2ftp_globals["directory"]; ?>"></td>
	</tr>
</table>
