...
<!-- Template /skins/ispCP/browse_main_details.template.php begin -->
...
<?php /* ----- Up ----- */ ?>
		<tr class="browse_rows_even" onmouseover="this.style.color='#000000'; this.style.backgroundColor='#84D0FA';" onmouseout="this.style.color='#000000'; this.style.backgroundColor='#F2F2F5';">
			<td></td>
...
// -------------------------- ?>
			<tr class="browse_rows_<?php echo $odd_even; ?>" id="row<?php echo $rowcounter; ?>" onmouseover="this.style.color='#000000'; this.style.backgroundColor='#84D0FA';" onmouseout="this.style.color='#000000'; setColor_js(<?php echo $rowcounter; ?>, 'checkbox');">
...
// -------------------------- ?>
			<tr class="browse_rows_<?php echo $odd_even; ?>" id="row<?php echo $rowcounter; ?>" onmouseover="this.style.color='#000000'; this.style.backgroundColor='#84D0FA';" onmouseout="this.style.color='#000000'; setColor_js(<?php echo $rowcounter; ?>, 'hidden');">
...
<?php			if ($rowcounter % 2 == 1) { $odd_even = "odd"; }
			...
			<tr class="browse_rows_<?php echo $odd_even; ?>" id="row<?php echo $i; ?>" onmouseover="this.style.color='#000000'; this.style.backgroundColor='#84D0FA';" onmouseout="this.style.color='#000000'; setColor_js(<?php echo $i; ?>);">
...
<!-- Template /skins/ispCP/browse_main_details.template.php end -->
