  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon.jpg" width="85" height="62" align="absmiddle">{TR_ENABLE_MAIL_AUTORESPONDER}</td>
		...
		<td nowrap class="content"> 
                  <textarea name="arsp_message" cols="50" rows="15" wrap="virtual">{ARSP_MESSAGE}</textarea>
                </td>
              </tr>
            </table>
