...
$net2ftp_messages["Checking files"] = "בודק קבצים";
$net2ftp_messages["Transferring files to the FTP server"] = "מעלה קבצים לשרת";
...
$net2ftp_messages["Script finished in %1\$s seconds"] = "מהפעולה התבצע תוך  %1\$s שניות";
...
// -------------------------------------------------------------------------
$net2ftp_messages["An error has occured"] = "התרחשה תקלה";
$net2ftp_messages["Go back"] = "חזור דף אחרוה";
$net2ftp_messages["Go to the login page"] = "עבור לעמוד כניסה";
...
$net2ftp_messages["File <b>%1\$s</b> is OK"] = "קובץ <b>%1\$s</b> תקין";
...
$net2ftp_messages["File <b>%1\$s</b> has been transferred to the FTP server using FTP mode <b>%2\$s</b>"] = "הקובץ <b>%1\$s</b> הועלה לשרת";
$net2ftp_messages["Transferring files to the FTP server"] = "מעלה קבצים לשרת";
...
// /skins/skins.inc.php
// -------------------------------------------------------------------------
$net2ftp_messages["Blue"] = "כחול";
$net2ftp_messages["Grey"] = "אפור";
$net2ftp_messages["Black"] = "שחור";
$net2ftp_messages["Yellow"] = "צהוב";
$net2ftp_messages["Pastel"] = "פסטל";

// getMime()
$net2ftp_messages["Directory"] = "ספריה";
...
$net2ftp_messages["Font file"] = "קובץ פונט";
$net2ftp_messages["%1\$s File"] = "%1\$s קובץ";
$net2ftp_messages["File"] = "קובץ";

// getAction()
$net2ftp_messages["Back"] = "חזרה";
$net2ftp_messages["Submit"] = "שלח";
$net2ftp_messages["Refresh"] = "רענן";
$net2ftp_messages["Details"] = "פרטים";
$net2ftp_messages["Icons"] = "Icons";
$net2ftp_messages["List"] = "רשימה";
$net2ftp_messages["Logout"] = "התנתק";
$net2ftp_messages["Help"] = "עזרה";
$net2ftp_messages["Bookmark"] = "הוסף לספר כתובות";
$net2ftp_messages["Save"] = "שמור";
$net2ftp_messages["Default"] = "ברירת מחדל";
...
$net2ftp_messages["Password length"] = "אורך סיסמא";
$net2ftp_messages["Passive mode"] = "מצב העברה פסיבי";
$net2ftp_messages["Directory"] = "ספריה";
...
$net2ftp_messages["New dir"] = "צור ספריה";
$net2ftp_messages["New file"] = "צור קובץ";
$net2ftp_messages["HTML templates"] = "HTML templates";
$net2ftp_messages["Upload"] = "העלה קובץ";
$net2ftp_messages["Java Upload"] = "ממשק JAVA";
$net2ftp_messages["Flash Upload"] = "ממשק FLASH";
$net2ftp_messages["Install"] = "התקן מערכת";
$net2ftp_messages["Advanced"] = "מתקדם";
$net2ftp_messages["Copy"] = "העתק";
$net2ftp_messages["Move"] = "העבר";
$net2ftp_messages["Delete"] = "מחק";
$net2ftp_messages["Rename"] = "שנה שם";
$net2ftp_messages["Chmod"] = "הרשאות";
$net2ftp_messages["Download"] = "כווץ והורד";
$net2ftp_messages["Unzip"] = "פתח כיווץ";
$net2ftp_messages["Zip"] = "כווץ";
$net2ftp_messages["Size"] = "גודל";
$net2ftp_messages["Search"] = "חיפוש";
$net2ftp_messages["Go to the parent directory"] = "עבור ספריה אחת למעלה";
$net2ftp_messages["Go"] = "Go";
$net2ftp_messages["Transform selected entries: "] = "העבר קבצים  נבחרים: ";
...
$net2ftp_messages["All"] = "הכל";
$net2ftp_messages["Name"] = "שם";
$net2ftp_messages["Type"] = "סוג";
//$net2ftp_messages["Size"] = "Size";
$net2ftp_messages["Owner"] = "יוצר";
$net2ftp_messages["Group"] = "קבוצה";
$net2ftp_messages["Perms"] = "הרשאות";
$net2ftp_messages["Mod Time"] = "שונה בתאריך";
$net2ftp_messages["Actions"] = "פעולות";
...
$net2ftp_messages["This folder is empty"] = "הספריה ריקה";

// printSeparatorRow()
$net2ftp_messages["Directories"] = "ספריות";
$net2ftp_messages["Files"] = "קבצים";
$net2ftp_messages["Symlinks"] = "קישורים";
$net2ftp_messages["Unrecognized FTP output"] = "פעולות FTP לא מזוהות";
$net2ftp_messages["Number"] = "מספר";
$net2ftp_messages["Size"] = "גודל";
$net2ftp_messages["Skipped"] = "דולג";
$net2ftp_messages["Data transferred from this IP address today"] = "כמות המידע שהועברה מכתובתך היום";
$net2ftp_messages["Data transferred to this FTP server today"] = "כמות המידע שהועברה לשרת היום";

// printLocationActions()
$net2ftp_messages["Language:"] = "שפה:";
$net2ftp_messages["Skin:"] = "Skin:";
$net2ftp_messages["View mode:"] = "מצב צפייה:";
$net2ftp_messages["Directory Tree"] = "עץ ספריות";
...
// -------------------------------------------------------------------------
$net2ftp_messages["Size of selected directories and files"] = "גודל הקבצים והספריות שנבחרו";
$net2ftp_messages["The total size taken by the selected directories and files is:"] = "גודל הספריות והקבצים שנבחרו הינו ";
...
// -------------------------------------------------------------------------
$net2ftp_messages["Choose a directory"] = "Choose a directory";
$net2ftp_messages["Copy directories and files"] = "העתק קבצים וספריות";
$net2ftp_messages["Move directories and files"] = "העבר קבצים וספריות";
$net2ftp_messages["Delete directories and files"] = "מחק קבצים וספריות";
$net2ftp_messages["Are you sure you want to delete these directories and files?"] = "האם את/ה בטוח/ה שאת/ה רוצה למחוק את הקבצים והספריות?";
$net2ftp_messages["All the subdirectories and files of the selected directories will also be deleted!"] = "כל הקצבים והספריות שנבחרו יימחקו !";
...
$net2ftp_messages["Copy directory <b>%1\$s</b> to:"] = "העתק ספריה <b>%1\$s</b> אל:";
$net2ftp_messages["Move directory <b>%1\$s</b> to:"] = "העבר ספריה <b>%1\$s</b> אל:";
$net2ftp_messages["Directory <b>%1\$s</b>"] = "הספריה <b>%1\$s</b>";
$net2ftp_messages["Copy file <b>%1\$s</b> to:"] = "העתק קובץ <b>%1\$s</b> אל:";
$net2ftp_messages["Move file <b>%1\$s</b> to:"] = "העבר קובץ <b>%1\$s</b> אל:";
...
$net2ftp_messages["Target directory:"] = "ספריית יעד:";
$net2ftp_messages["Target name:"] = "שם יעד:";
$net2ftp_messages["Processing the entries:"] = "מעבד בקשות:";
...
$net2ftp_messages["Once you are logged in, you will be able to:"] = "כדי להשתמש במערכת,עלייך קודם להתחבר";
...
$net2ftp_messages["Passive mode"] = "מצב העברה פסיבי";
$net2ftp_messages["Initial directory"] = "ספרייה התחלתית";
$net2ftp_messages["Language"] = "שפה";
$net2ftp_messages["Skin"] = "סוג ממשק";
$net2ftp_messages["FTP mode"] = "צורת העברת קבצים";
$net2ftp_messages["Automatic"] = "אוטומטי";
$net2ftp_messages["Login"] = "התחבר";
$net2ftp_messages["Clear cookies"] = "נקה קוקי'ז";
$net2ftp_messages["Admin"] = "ממשק ניהול";
$net2ftp_messages["Please enter an FTP server."] = "הכנס כתובת שרת FTP, בבקשה";
$net2ftp_messages["Please enter a username."] = "הכנס שם משתמש, בבקשה";
$net2ftp_messages["Please enter a password."] = "הכנס סיסמא, בבקשה";
...
// logout.template.php
$net2ftp_messages["You have logged out from the FTP server. To log back in, <a href=\"%1\$s\" title=\"Login page (accesskey l)\" accesskey=\"l\">follow this link</a>."] = "התנתקת מהשרת. לחץ , <a href=\"%1\$s\" title=\"Login page (accesskey l)\" accesskey=\"l\">כאן</a> על מנת להתחבר שוב.";
$net2ftp_messages["Note: other users of this computer could click on the browser's Back button and access the FTP server."] = "";
$net2ftp_messages["To prevent this, you must close all browser windows."] = "להשלמת תהליך ההתנתקות מהשרות, מומלץ לסגור את החלון הנוכחי.";
$net2ftp_messages["Close"] = "סגור חלון";
$net2ftp_messages["Click here to close this window"] = "לחץ כאן כדי לסגור את החלון הנוכחי";
...
// -------------------------------------------------------------------------
$net2ftp_messages["Upload to directory:"] = "העלה קבצים לספריה:";
$net2ftp_messages["Files"] = "קבצים";
$net2ftp_messages["Archives"] = "קבצים מכווצים";
$net2ftp_messages["Files entered here will be transferred to the FTP server."] = "בחר קבצים להעלות לשרת.";
$net2ftp_messages["Archives entered here will be decompressed, and the files inside will be transferred to the FTP server."] = "תוכן הקבצים  המכווצים  ישוחזר, והקבצים  המשוחזרים יועלו לשרת.";
$net2ftp_messages["Add another"] = "הוסף";
$net2ftp_messages["Use folder names (creates subdirectories automatically)"] = "Use folder names (creates subdirectories automatically)";

$net2ftp_messages["Choose a directory"] = "Choose a directory";
$net2ftp_messages["Please wait..."] = "Please wait...";
$net2ftp_messages["Uploading... please wait..."] = "מעלה... המתן בבקשה...";
$net2ftp_messages["If the upload takes more than the allowed <b>%1\$s seconds<\/b>, you will have to try again with less/smaller files."] = "אם העלאת הקבצים לוקחת יותר מהמותר, <b>%1\$s שניות<\/b>, אנא, נסה/י שנית, עם פחות קבצים.";
...
$net2ftp_messages["Close window now"] = "סגור את החלון";

$net2ftp_messages["Upload files and archives"] = "העלה קבצים";
$net2ftp_messages["Upload results"] = "תוצאות תהליך העלאה";
$net2ftp_messages["Checking files:"] = "בודק קבצים:";
$net2ftp_messages["Transferring files to the FTP server:"] = "מעלה קבצים לשרת FTP:";
$net2ftp_messages["Decompressing archives and transferring files to the FTP server:"] = "משחזר את תוכן הקבצים, ומעלה אותם לשרת:";
$net2ftp_messages["Upload more files and archives"] = "העלה עוד קבצים";
...
$net2ftp_messages["Save the zip file on the FTP server as:"] = "שמור את הקבצים מכווצים תחת השם:";
$net2ftp_messages["Email the zip file in attachment to:"] = "שלח את הקבצים אל:";
$net2ftp_messages["Note that sending files is not anonymous: your IP address as well as the time of the sending will be added to the email."] = "";
$net2ftp_messages["Some additional comments to add in the email:"] = "הוסף הערות לאימייל שיישלח:";

$net2ftp_messages["You did not enter a filename for the zipfile. Go back and enter a filename."] = "לא נתת שם לשמירה. אנא חזור, ותן שם לשמירה.";
$net2ftp_messages["The email address you have entered (%1\$s) does not seem to be valid.<br />Please enter an address in the format <b>username@domain.com</b>"] = "כתובת האימייל שהכנסת  (%1\$s) נראית לא חוקית.<br />אנא הכנס כתובת אימייל, בצורת <b>username@domain.com</b>";
