...
<table>
    ...
    <tr>
        <td>
            ...
            <a href="domain_status_change.php?domain_id={DOMAIN_ID}" class="icon i_{STATUS_ICON}" title="{DOMAIN_STATUS_TOOLTIP}">{DOMAIN_STATUS}</a>
    ...
    <!-- BDP: user_details -->
    <tr>
        <td colspan="5"><a href="http://www.{ALIAS_DOMAIN}/" target="_blank" class="icon i_goto" title=""{ALIAS_DOMAIN}>{ALIAS_DOMAIN}</a></td>
    </tr>
    <!-- EDP: user_details -->
    <!-- EDP: user_entry -->
    </tbody>
