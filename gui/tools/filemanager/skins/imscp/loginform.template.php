...
<?php						if ($ftpserver["inputType"] != "hidden") {
								echo __("FTP server");
							}
							if ($ftpserver["inputType"] != "hidden" && $ftpserverport["inputType"] == "text") {
								echo ":";
							}
							if ($ftpserverport["inputType"] == "text") {
								echo __("Port");
							} ?></td>
							<td colspan="2" style="vertical-align: top; padding-top:5px;">
<?php								if ($ftpserver["inputType"] == "hidden") { ?>
									<input type="hidden" name="ftpserver" value="<?php echo $ftpserver["list"][1]; ?>" style="width:230px;" />
...
<?php								} elseif ($ftpserver["inputType"] == "text") { ?>
									<input type="text" name="ftpserver" value="<?php echo $ftpserver["list"][1]; ?>" style="width:188px;" />
									<b><?php echo $ftpserver["list"][1]; ?></b>
<?php								} ?>
<?php /* ----- FTP server port ----- */ ?>
<?php								if ($ftpserverport["inputType"] == "text") { ?>
									<input size="3" maxlength="5" name="ftpserverport" value="<?php echo $ftpserverport["value"]; ?>" type="text" />
<?php								} else { ?>
...
<?php /* ----- Anonymous checkbox ----- */ ?>
							<td style="width: 27%;"><input name="anonymous" value="1" onclick="do_anonymous(form);" type="hidden" />&nbsp; </td>
						</tr>
<?php /* ----- Password ----- */ ?>
						<tr style="vertical-align: middle;">
...
<?php /* ----- FTP mode radio button ----- */ ?>
						<tr style="vertical-align: middle;">
							...
							<td colspan="2">
								...
								<input name="ftpmode" value="automatic" <?php echo $ftpmode["automatic"]; ?> type="radio" />&nbsp; <?php echo __("Automatic"); ?>							</td>
						</tr>
<?php /* ----- Login button ----- */ ?>
						<tr>
							<td></td>
							<td colspan="2" style="padding-<?php echo __("left"); ?>: 40px;">
								<input type="submit" class="button" name="Login" value="<?php echo __("Login"); ?>" alt="<?php echo __("Login"); ?>" />							</td>
						</tr>
<?php /* ----- Clear cookies and Admin link ----- */ ?>
						<tr style="vertical-align: middle; text-align: left;">
							...
							<td colspan="2" style="text-align: <?php echo __("right"); ?>; padding-<?php echo __("right"); ?>: 20px; padding-bottom: 5px;">
								<a href="javascript:ClearCookies();"><?php echo __("Clear cookies"); ?></a> </td>
						</tr>
					</tbody>
				</table>
