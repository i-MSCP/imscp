...
* 2) Die PHP Datei einmal ausfuehren indem Du sie mit dem Browser aufrufst (http://www.Deine-ISPCPAdresse.de/mysql_fix.php)
...
include("include/ispcp-db-keys.php");
include("include/ispcp-config.php");
