...
The DNS zone templates files located at `/etc/imscp/bind/parts` were updated. If you
make use of your own, you must not forget to sync them with latest changes.
