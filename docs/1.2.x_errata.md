...
Due to major changes in this new version, you must deactivate all plugins before starting the update process. Once the
update finished, you must not forget to update your plugins to latest available version before re-activating them.
