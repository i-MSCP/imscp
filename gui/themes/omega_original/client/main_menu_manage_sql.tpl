...
<!-- BDP: isactive_sql -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="sql_manage.php" onmouseover="MM_swapImage('databases','','{THEME_COLOR_PATH}/images/icons/database_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/database_a.gif" name="databases" width="47" height="46" border="0" id="databases" /></a></div></td>
  </tr><tr>
