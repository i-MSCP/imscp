=head1 NAME
 ...
 Servers::sqld::Mariadb::Abstract - i-MSCP MariaDB SQL server abstract implementation
...
package Servers::sqld::Mariadb::Abstract;
...
=item _setVendor( )
 ...
 See Servers::sqld::Mysql::Abstract::_setVendor()
