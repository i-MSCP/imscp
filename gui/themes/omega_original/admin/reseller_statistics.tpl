                        ...
                        <br />
                          <table width="100%" cellspacing="3">
                            ...
                            <tr>
                              ...
                              <td class="{ITEM_CLASS}" nowrap="nowrap" align="center"><b><a href="reseller_statistics.php?rid={RESELLER_ID}&amp;name={RESELLER_NAME}&amp;month={MONTH}&amp;year={YEAR}" title="{RESELLER_NAME}" class="link">{RESELLER_NAME}</a></b></td>
