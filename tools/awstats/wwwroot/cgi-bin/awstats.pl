...
$REVISION='$Revision: 1.885 $'; $REVISION =~ /\s(.*)\s/; $REVISION=$1;
...
sub Read_Ref_Data {
	...
	my @PossibleLibDir=("$DIR/lib","/usr/share/awstats/lib","/var/www/awstats/lib");
...
sub Read_Language_Data {
	...
	my @PossibleLangDir=("$DirLang","$DIR/lang","/usr/share/awstats/lang","/var/www/awstats/lang");
...
sub Read_Plugins {
	...
	my @PossiblePluginsDir=("$DIR/plugins","/usr/local/awstats/wwwroot/cgi-bin/plugins","/usr/share/awstats/plugins","/var/www/awstats/plugins");
 	my %DirAddedInINC=();
