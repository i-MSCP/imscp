...
VsFTPd doesn't support non-ascii characters in usernames. Therefore to be compatible with both VsFTPD and
ProFTPD IDN domain names that are part of FTP usernames will be converted to IDNA form. This means that
