            ...
            <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left"><table width="100%" cellpadding="5" cellspacing="5">
                    <tr>
                      <td width="25"><img src="{THEME_COLOR_PATH}/images/content/table_icon_purchasing.png" width="25" height="25"></td>
              ...
              <tr>
                <td valign="top"><table width="100%" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td class="content3"><img src="{THEME_COLOR_PATH}/images/icons/details.png" width="18" height="18" border="0" align="absmiddle"> <a href="update_hosting_plan.php?{LINK}={ID}" class="linkdark">{TR_PURCHASE}</a></td>
                    </tr>
                    <!-- EDP: hosting_plans -->
                </table></td>
                <td>&nbsp;</td>
