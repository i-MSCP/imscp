  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td height="420" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_serverstatus.jpg" width="85" height="62" align="absmiddle">{TR_EDIT_HOSTING_PLAN}</td>
            <td width="27" align="right" background="{THEME_COLOR_PATH}/images/content/table_background.jpg"><img src="{THEME_COLOR_PATH}/images/content/table_icon_close.jpg" width="27" height="62"></td>
          </tr>
          <tr>
            <td valign="top">
			<form name="reseller_edit_host_plant_frm" method="post" action="ehp.php">
			  ...
			  <td width="20">&nbsp;</td>
                ...
                <td width="242"  class="content"> 
                  <input type="text" {READONLY} name=hp_als value="{TR_MAX_ALS_VALUES}" style="width:100px" class="textinput">
                </td>
              </tr>
