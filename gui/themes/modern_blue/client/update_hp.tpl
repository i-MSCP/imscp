...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  <tr>
    <td height="80" align="left"><table width="100%"  border="00" cellspacing="0" cellpadding="0">
      <tr>
  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_purchasing.jpg" width="85" height="62" align="absmiddle">{TR_MENU_UPDATE_HP}</td>
