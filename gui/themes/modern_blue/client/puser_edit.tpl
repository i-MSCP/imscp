...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top">
		<form name="add_user_group" method="post" action="puser_edit.php">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_user.jpg" width="85" height="62" align="absmiddle">{TR_UPDATE_USER}</td>
