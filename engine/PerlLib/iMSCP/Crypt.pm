...
=item randomStr( $length [, $charList = BASE64 ] )
 ...
 Param bool string $charList character list to use for string generation (default is Base64 character set)
...
sub randomStr( $;$ )
{
    ...
    return $charList x $length if $listLen == 1;
