...
#
## Allows to override PHP-FPM settings globally or per domain.
##
...
my %SETTINGS = (
    ...
    # Per domain PHP-FPM settings - Any setting added here will apply to specified domains
    'test.bbox.nuxwin.com' => {
        'pm'                   => 'dynamic',
        'pm.max_children'      => 10,
        'pm.start_servers '    => 2,
        'pm.min_spare_servers' => 1,
