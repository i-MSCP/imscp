...
Support for MySQL 5.6.x and MySQL 5.7.x has been added. Note that support for these versions has been added through
MySQL repositories and is still experimental.
