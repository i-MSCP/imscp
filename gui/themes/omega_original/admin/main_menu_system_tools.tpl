...
<!-- EDP: hosting_plans -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="system_info.php" onmouseover="MM_swapImage('webtools','','{THEME_COLOR_PATH}/images/icons/webtools_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/webtools_a.gif" name="webtools" width="47" height="46" border="0" alt="" id="webtools" /></a></div></td>
  </tr><tr>
