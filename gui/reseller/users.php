...
function generate_users_list($tpl, $admin_id) {
	...
	if (isset($_SESSION['search_for'])) {
		gen_manage_domain_query($search_query, $count_query, $admin_id,
	...
	if ($records_count == 0) {
		if (isset($_SESSION['search_for'])) {
			...
			set_page_message(tr('You do not have customers.'));
		}
	} else {
		...
		while (!$rs->EOF) {
            ...
            $tpl->assign('CLASS_TYPE_ROW', ($i % 2 == 0) ? 'content' : 'content2');
