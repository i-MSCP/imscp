=head1 NAME
 ...
 Servers::sqld::Remote::Abstract - i-MSCP Remote SQL server abstract implementation
...
package Servers::sqld::Remote::Abstract;
...
use version;
use parent 'Servers::sqld::Mysql::Abstract';

=head1 DESCRIPTION

 i-MSCP Remote SQL server abstract implementation.
...
=item postinstall( )
 ...
 See Servers::sqld::Mysql::Abstract::postinstall()
...
=item restart( )
 ...
 See Servers::sqld::Mysql::Abstract::restart()
...
=item setEnginePermissions( )
 ...
 See Servers::sqld::Mysql::Abstract::setEnginePermissions()
...
=item createUser( $user, $host, $password )
 ...
 See Servers::sqld::Mysql::Abstract::createUser()
...
=item _buildConf( )
 ...
 See Servers::sqld::Mysql::Abstract::_buildConf()
...
=item _updateServerConfig( )
 ...
 See Servers::sqld::Mysql::Abstract::_updateServerConfig()
