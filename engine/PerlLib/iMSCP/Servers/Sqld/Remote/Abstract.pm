=head1 NAME
 ...
 iMSCP::Servers::Sqld::Remote::Abstract - i-MSCP Remote SQL server abstract implementation
...
package iMSCP::Servers::Sqld::Remote::Abstract;
...
=item restart( )
 ...
 See iMSCP::Servers::Sqld::Mysql::Abstract::restart()
...
=item setEnginePermissions( )
 ...
 See iMSCP::Servers::Sqld::Mysql::Abstract::setEnginePermissions()
...
sub _updateServerConfig
{
    ...
    # FIXME
    if ( $main::imscpConfig{'SQL_PACKAGE'} eq 'iMSCP::Servers::Sqld::mariadb' ) {
