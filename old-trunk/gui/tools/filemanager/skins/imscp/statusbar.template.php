...
<!-- Template /skins/imscp/statusbar.php begin -->
...
<?php require_once($net2ftp_globals["application_skinsdir"] . "/" . $net2ftp_globals["skin"] . "/status/status.template.php"); ?>
	<div id="head">
		<div id="headleft">
			<a href="http://www.i-mscp.net" target="_blank"><img src="<?php echo $net2ftp_globals["image_url"]; ?>/img/logo.png" alt="net2ftp" width="193" height="59" border="0" /></a>
...
<!-- Template /skins/imscp/statusbar.php end -->
