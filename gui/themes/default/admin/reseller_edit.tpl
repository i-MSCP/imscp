        ...
        <script language="JavaScript" type="text/JavaScript">
            /*<![CDATA[*/
                $(document).ready(function() {
                    ...
                    $('input[name=pwdreset]').click(function(){gpwd=false;$(':password').val('').attr('readonly',false);});
                    $(':input').live('keypress', function(e){if(e.keyCode==13){e.preventDefault();alert('{TR_EVENT_NOTICE}');}});
