<?php
/* $Id: brazilian_portuguese-utf-8.inc.php,v 2.143.2.2 2006/08/30 10:43:14 nijel Exp $ */
...
$strInvalidServerHostname = 'Nome de host inválido para o servidor %1$s. Verifique suas configurações.';
...
$strShowSlaveHosts = 'Exibir hosts escravos';
...
$strTransformation_application_octetstream__hex = 'Exibir representação hexadecimal dos dados. Primeiro parâmetro opcional especifica como frequentemente espaços serão adicionados (padrão para 2 mordidelas).';  //ta certo isso? nibbles, traduzi como moridelas
...
$strUsedPhpExtensions = 'Usadas extensões PHP';
