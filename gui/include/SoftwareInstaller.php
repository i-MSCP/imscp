 ...
 * @return int
 */
function get_avail_software(TemplateEngine $tpl)
{
    $stmt = execute_query(
        "
 ...
 * @return int
 */
function get_avail_softwaredepot(TemplateEngine $tpl)
{
    $stmt = execute_query(
        "
          SELECT a.software_id AS id, a.software_name AS name, a.software_version AS version,
 ...
 * @return int
 */
function get_installed_res_software(TemplateEngine $tpl, $resellerId)
{
    $stmt = exec_query(
        "
          SELECT a.software_id AS id, a.software_name AS name, a.software_version AS version,
 ...
 * @return int
 */
function get_reseller_software(TemplateEngine $tpl)
{
    $stmt = execute_query(
        "
 ...
 * @return int
 */
function get_reseller_rights(TemplateEngine $tpl, $softwareId)
{
    $stmt = exec_query(
        "
 ...
 * @return void
 */
function get_reseller_list(TemplateEngine $tpl, $softwareId)
{
    $stmt = execute_query(
        "
 ...
 * @return int
 */
function get_avail_software_reseller(TemplateEngine $tpl, $userId)
{
 ...
 * @return array
 */
function gen_user_software_action($softwareId, $dmnId, TemplateEngine $tpl)
{
 ...
 */
function gen_software_list(TemplateEngine $tpl, $domainId, $resellerId)
{
    $stmt = exec_query(
        '
 ...
 * @return void
 */
function check_is_installed(TemplateEngine $tpl, $dmnId, $softwareId)
{
    $stmt = exec_query(
        '
 ...
 * @return void
 */
function get_software_props(TemplateEngine $tpl, $dmnId, $softwareId, $dmnCreatedId)
{
 ...
 * @return void
 */
function get_software_props_install(TemplateEngine $tpl, $dmnId, $softwareId, $dmnCreatedId, $dmnSqldLimit)
{
    if (!check_software_avail($softwareId, $dmnCreatedId)) {
        set_page_message(tr('Software not found!'), 'error');
        redirectTo('software.php');
 ...
 * @return void
 */
function gen_user_domain_list(TemplateEngine $tpl, $customerId)
{
    $domainFound = false;
