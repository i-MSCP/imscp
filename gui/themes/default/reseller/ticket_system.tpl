...
<table>
    ...
    <tr>
        ...
        <td>
            <a href="ticket_delete.php?ticket_id={TICKET_ID_VAL}" class="icon i_delete" onclick="return action_delete('{TICKET_SUBJECT2_VAL}')" class="link" title="{TR_TICKET_DELETE_LINK}">{TR_TICKET_DELETE}</a>
