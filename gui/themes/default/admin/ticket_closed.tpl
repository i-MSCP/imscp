...
<table>
	...
	<tr>
		...
		<td>
			...
			<img src="{THEME_ASSETS_PATH}/images/icons/open.png" style="vertical-align:middle;" alt=""/>&nbsp;
	...
	<tr>
		<td colspan="6">
			<div class="buttons">
				<input name="deleteAll" type="button"
					   onclick="return action_delete('ticket_delete.php?delete=closed', 'all');"
