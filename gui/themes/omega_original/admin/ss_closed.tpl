    ...
    <td><table width="100%"  border="00" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top"><table width="100%" cellspacing="7">
          ...
          <!-- BDP: tickets_list -->
          <tr>
            <td colspan="2" nowrap="nowrap" class="content3"><b>{TR_SUBJECT}</b></td>
          ...
          <!-- EDP: tickets_item -->
          <tr>
            <td colspan="2" nowrap="nowrap"><input name="Submit" type="submit" class="button" onClick="MM_goToURL('parent','delete_ticket.php?delete=open');return document.MM_returnValue" value="{TR_DELETE_ALL}" /></td>
