...
<?php require_once($net2ftp_globals["application_skinsdir"] . "/" . $net2ftp_globals["skin"] . "/header_login.template.php"); ?>
	<div id="main">
		<div id="menu">
			<div class="menuhead">Learn more</div>
			<div class="menucontent">
				<ul class="navlist">
					<li style="font-weight: bold;">Home</li>
					<li><a href="homepage/screenshots.html">Screenshots</a></li>
					<li><a href="homepage/features.html">Features</a></li>
				</ul>
			</div>
			<br />
			<div class="menuhead">Community</div>
			<div class="menucontent">
				<ul class="navlist">
					<li><a href="http://www.net2ftp.org/forums">Forums</a></li>
				</ul>
			</div>
			<br />
			<div class="menuhead">Download and Install</div>
			<div class="menucontent">
				<ul class="navlist">
					<li><a href="homepage/download.html">Download</a> <a href="http://www.net2ftp.com/download/net2ftp_v0.98.zip" style="font-size: 0.75em">Stable 0.98</a></li>
					<li><a href="homepage/installation.html">Installation instructions</a></li>
				</ul>
			</div>
			<br />
			<div class="menuhead">Help</div>
			<div class="menucontent">
				<ul class="navlist">
					<li><a href="help.html" target="_blank">Help guide</a></li>
					<li><a href="http://www.net2ftp.org/forums">Ask a question</a></li>
				</ul>
			</div>
			<br />
			<div class="menuhead">Abuse</div>
			<div class="menucontent">
				<ul class="navlist">
					<li><a href="homepage/abuse.html">Abuse</a></li>
				</ul>
			</div>
			<br />
...
<br />
<?php require_once($net2ftp_globals["application_rootdir"] . "/homepage/announcements.html"); ?>

<textarea rows="4" readonly="readonly" style="margin: 0; padding: 0; width: 600px;">
