...
<tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="domains_manage.php" onmouseover="MM_swapImage('domains','','{THEME_COLOR_PATH}/images/icons/domains_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/domains_a.gif" name="domains" width="47" height="46" border="0" id="domains" /></a></div></td>
  </tr><tr>
