...
userland cache for caching of localization and translation resources. If for
any reason, the APCu extension is not available, there is a fallback on another
but more slower cache backend (File caching).
