...
$tpl->assign(
	array(
		...
		'TR_YES' => tr('yes'),
		'TR_NO' => tr('no'),
		'TR_SOFTWARE_SUPP' => tr('Apps installer'),
		'TR_SOFTWAREDEPOT_SUPP' => tr('Can use softwaredepot'),
		'SOFTWARE_YES' => ($rdata['software_allowed'] == 'yes') ? $cfg->HTML_SELECTED : '',
		'SOFTWARE_NO' => ($rdata['software_allowed'] != 'yes') ? $cfg->HTML_SELECTED : '',
		'SOFTWAREDEPOT_YES'	=> ($rdata['softwaredepot_allowed'] == 'yes') ? $cfg->HTML_SELECTED : '',
		'SOFTWAREDEPOT_NO' => ($rdata['softwaredepot_allowed'] != 'yes') ? $cfg->HTML_SELECTED : '',
