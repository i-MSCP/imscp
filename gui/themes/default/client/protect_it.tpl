<script>
    $(function () {
        $("#ptype_1,#ptype_2").on("change", function () {
            if ($(this).is(":checked")) {
...
<form name="addProtectedAreaFrm" method="post" action="protected_areas_add.php">
    ...
    <table class="firstColFixed">
        ...
        <tr>
            <td>
                <label>
                    <select name="users[]" multiple="multiple" size="10" style="min-width:150px">
                        <!-- BDP: user_item -->
            ...
            <td>
                <label>
                    <select name="groups[]" multiple="multiple" size="10" style="min-width:150px">
                        <!-- BDP: group_item -->
    ...
    <div class="buttons">
        <input type="submit" value="{TR_PROTECT_IT}">
