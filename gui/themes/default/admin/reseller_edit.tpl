						...
						<div style="margin:0" id="php_editor_dialog" title="{TR_PHP_EDITOR_SETTINGS}">
							...
							<table>
								...
								<tr>
									...
									<td>
										<input name="php_ini_max_post_max_size" id="php_ini_max_post_max_size" type="text" value="{PHP_INI_MAX_POST_MAX_SIZE}"/> <span>{TR_MIB}</span>
									</td>
								</tr>
								<tr>
									<td><label for="php_ini_max_upload_max_filesize">{TR_PHP_INI_MAX_UPLOAD_MAX_FILESIZE}</label></td>
									<td>
										<input name="php_ini_max_upload_max_filesize" id="php_ini_max_upload_max_filesize" type="text" value="{PHP_INI_MAX_UPLOAD_MAX_FILESIZE}"/> <span>{TR_MIB}</span>
									</td>
								</tr>
								<tr>
									<td><label for="php_ini_max_max_execution_time">{TR_PHP_INI_MAX_MAX_EXECUTION_TIME}</label></td>
									<td>
										<input name="php_ini_max_max_execution_time" id="php_ini_max_max_execution_time" type="text" value="{PHP_INI_MAX_MAX_EXECUTION_TIME}"/> <span>{TR_SEC}</span>
									</td>
								</tr>
								<tr>
									<td><label for="php_ini_max_max_input_time">{TR_PHP_INI_MAX_MAX_INPUT_TIME}</label></td>
									<td>
										<input name="php_ini_max_max_input_time" id="php_ini_max_max_input_time" type="text" value="{PHP_INI_MAX_MAX_INPUT_TIME}"/> <span>{TR_SEC}</span>
									</td>
								</tr>
								<tr>
									<td><label for="php_ini_max_memory_limit">{TR_PHP_INI_MAX_MEMORY_LIMIT}</label></td>
									<td>
										<input name="php_ini_max_memory_limit" id="php_ini_max_memory_limit" type="text" value="{PHP_INI_MAX_MEMORY_LIMIT}"/> <span>{TR_MIB}</span>
									</td>
								</tr>
							</table>
							<!--
							<p style="width: 512px;margin-top: 10px;">
								<span style="font-variant: small-caps;"><strong>{TR_WARNING}</strong></span><br /><br />
								<span style="font-size: smaller;">{TR_PHP_SETTINGS_UPDATE_WARNING}</span>.
							</p>
							-->
						</div>
					</td>
