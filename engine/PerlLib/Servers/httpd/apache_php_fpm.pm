...
=item buildConf($cfgTpl, $filename, \%data)
 ...
 Param string $cfgTpl Template file content representing content of the configuration template
...
=item installConfFile($file [, \%options = { } ])
 ...
 Param hash \%options Options such as destination, mode, user and group for final file
 Return int 0 on success, other on failure
...
=item apacheBkpConfFile($filepath [, $prefix = '' [, $system = 0 ]])
 ...
 Param bool $system OPTIONAL Backup as system file (default false)
...
=item phpfpmBkpConfFile($filepath [, $prefix = '' [, $system = 0 ]])
 ...
 Param string $filepath Configuration file path
 Param string $prefix OPTIONAL Prefix to use
 Param bool $system OPTIONAL Param int $system Backup as system file (default false)
 Return 0 on success, other on failure
