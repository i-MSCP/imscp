...
<!-- Template /skins/omega/copymovedelete1.template.php begin -->
			...
			<table>
				<tr>
					...
					<td>
						...
						<?php printActionIcon("listdirectories", "createDirectoryTreeWindow('" . $net2ftp_globals["directory_js"] . "','CopyMoveDeleteForm.elements[list[$i][targetdirectory]]');"); ?>
					</td>
				</tr>
				<tr><td>
...
<!-- Template /skins/omega/copymovedelete1.template.php end -->
