...
Alternative URLs feature can now be disabled. In order, to enable/disable that
 feature, you must:
...
There is no better way to enable/disable that feature because the DNS and
...
# Execute the "testing" event 3 times
...
Note that the [iMSCP::EventManager::registerOne()](../engine/PerlLib/iMSCP/EventManager.pm#L86)
method is a simple wrapper around the [iMSCP::EventManager::register()](../engine/PerlLib/iMSCP/EventManager.pm#L45)
