...
use iMSCP_Exception_Event;
use iMSCP_Exception_Writer_Browser;
use iMSCP_Registry;
...
class ExceptionHandler extends AbstractHandler
{
    ...
    {
        $browserHandler = new iMSCP_Exception_Writer_Browser();

        ob_start();

        $browserHandler->onUncaughtException(new iMSCP_Exception_Event($error));
