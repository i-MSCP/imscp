...
<table border="0" cellspacing="2" cellpadding="2" style="margin-<?php echo __("left"); ?>: 20px;">
	<tr>
		...
		<td><?php echo $troubleshoot_ftpserver; ?></td>
	</tr>
	<tr>
		<td><?php echo __("FTP server port"); ?></td>
		<td><?php echo $troubleshoot_ftpserverport; ?></td>
	</tr>
	<tr>
		<td><?php echo __("Username"); ?></td>
		<td><?php echo $troubleshoot_username; ?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><?php echo $troubleshoot_passivemode; ?></td>
	</tr>
	<tr>
		<td><?php echo __("Directory"); ?></td>
		<td><?php echo $troubleshoot_directory; ?></td>
	</tr>
</table>
...
<li>
	<?php echo __("Getting the raw list of directories and files: "); ?>
