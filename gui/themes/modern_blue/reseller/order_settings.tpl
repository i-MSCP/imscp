  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_tools.jpg" width="85" height="62" align="absmiddle">{TR_MENU_ORDER_SETTINGS}</td>
          ...
          <tr>
			...
			<table width="100%" cellpadding="5" cellspacing="5">
              ...
              <tr>
				...
				<!-- EDP: purchase_header --></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
				...
				<!-- EDP: purchase_footer --></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
