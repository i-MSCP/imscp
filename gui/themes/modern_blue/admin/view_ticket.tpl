                  ...
                  <tr>
                    ...
                    <td valign="top"><form name="question_frm" method="post" action="view_ticket.php?ticket_id={ID}&screenwidth={SCREENWIDTH}">
                        <table width="100%" cellspacing="5">
                          ...
                          <tr>
                            <td><input name="Button" type="button" class="button" value="{TR_REPLY}" onClick="return sbmt(document.forms[0],'send_msg');">&nbsp;&nbsp;&nbsp;                              <input name="Button" type="button" class="button" value="{TR_ACTION}" onClick="return sbmt(document.forms[0],'{ACTION}');">
                            </td>
                            </tr>
                          <!-- EDP: tickets_list -->
                        </table>
