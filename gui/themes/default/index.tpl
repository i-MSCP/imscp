				...
				<div id="inner">
					<form name="login_frm" action="index.php" method="post">
						...
						<fieldset>
							...
							<div class="buttons">
								<input class="lostpwdButton" style="text-align:left;padding-left:15px;" type="submit" name="lpwd" value="{TR_LOSTPW}" tabindex="2" onclick="location.href='lostpassword.php';return false"/>&nbsp;&nbsp;&nbsp;
					...
					<div class="toolsbox">
    					<ul class="icons">
       						<li><a class="pma" href="{TR_PMA_SSL_LINK}">PhpMyAdmin</a></li>
       						<li><a class="filemanager" href="{TR_FTP_SSL_LINK}">FileManager</a></li>
       						<li><a class="webmail" href="{TR_WEBMAIL_SSL_LINK}">Webmail</a></li>
   						</ul>
					</div>
				</div>
			</div>
