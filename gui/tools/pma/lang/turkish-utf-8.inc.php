<?php
/* $Id: turkish-utf-8.inc.php 12185 2009-01-12 17:38:04Z lem9 $ */

// phpMyAdmin Türkçe (Turkish)
// Çeviren Burak Yavuz (BouRock)
// Çeviri phpMyAdmin 2.11.9.4 ve 3.1.1 sürümüne uygundur.
...
$strSetupServers_bookmarktable_desc = '[a@http://wiki.cihar.com/pma/bookmark]Yer imi[/a] desteği istenmiyorsa boş bırakın, varsayılan: [kbd]pma_bookmark[/kbd]';
...
$strSetupServers_controluser_desc = 'Sınırlı yetkilerle yapılandırılmış özel MySQL kullanıcısıdır, daha fazla bilgi [a@http://wiki.cihar.com/pma/controluser]wiki[/a]\'de mevcuttur';
...
$strSetupServers_pmadb_desc = 'İlişkiler, yer imleri ve PDF özellikleri için kullanılan veritabanı. Tam bilgi için [a@http://wiki.cihar.com/pma/pmadb]pmadb[/a]\'ye bakın. Destek istenmiyorsa boş bırakın. Varsayılan: [kbd]phpmyadmin[/kbd]';
...
$strSetupServers_relation_desc = '[a@http://wiki.cihar.com/pma/relation]İlişki bağlantıları[/a] desteği istenmiyorsa boş bırakın, varsayılan: [kbd]pma_relation[/kbd]';
...
$strSetupServers_SignonSession_desc = 'Örnek için [a@http://wiki.cihar.com/pma/auth_types#signon]Kimlik denetimi türlerine[/a] bakın';
