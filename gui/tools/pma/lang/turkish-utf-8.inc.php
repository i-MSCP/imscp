<?php
/* $Id: turkish-utf-8.inc.php,v 2.148.2.1 2006/09/07 16:47:30 lem9 Exp $ */
...
$strCantRenameIdxToPrimary = 'İndeks\'i PRIMARY olarak yeniden adlandırımazsınız!';
...
$strHTMLWordOptions = 'Microsoft Word 2000 dışarı aktarma seçenekleri';
...
$strMIME_transformation_options_note = 'Lütfen dönüşüm seçenekleri için değerleri bu biçimi kullanarak giriniz: \'a\',\'b\',\'c\'...<br />Eğer bu değerler arasına hep ters eğik çizgi ("\") veya tek tırnak ("\'") koymanız gerekirse, önlerine ters eğik çizgi koyun (örneğin \'\\\\xyz\' veya \'a\\\'b\').';
...
$strOpenDocumentSpreadsheetOptions = 'Açık Belge Hesap Çizelgesi seçenekleri';
$strOpenDocumentText = 'Açık Belge Metini';
$strOpenDocumentTextOptions = 'Açık Belge Metini seçenekleri';
...
$strTransformation_text_plain__dateformat = 'Yerel tarih/zaman\'ınıza göre TIME, TIMESTAMP veya DATETIME alanını görüntüler. İlk seçenek zaman damgasına eklenecek olan karşılıktır (saat cinsinden) (Varsayılan: 0). Farklı tarih/saat biçimi dizgisi belirlemek için ikinci seçeneği kullanın; PHP\'nin strftime() işlevi için belgelere bakın.';
