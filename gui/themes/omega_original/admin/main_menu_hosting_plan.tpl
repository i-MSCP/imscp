...
<tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="manage_users.php" onmouseover="MM_swapImage('manage_users','','{THEME_COLOR_PATH}/images/icons/manage_users_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/manage_users.gif" name="manage_users" width="47" height="46" border="0" alt="" id="manage_users" /></a></div></td>
  </tr><tr>
...
<!-- BDP: hosting_plans -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="hosting_plan.php" onmouseover="MM_swapImage('hosting_plans','','{THEME_COLOR_PATH}/images/icons/hosting_plans_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/hosting_plans_a.gif" name="hosting_plans" width="47" height="46" border="0" alt="" id="hosting_plans" /></a></div></td>
  </tr><tr>
...
<!-- EDP: hosting_plans -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="system_info.php" onmouseover="MM_swapImage('webtools','','{THEME_COLOR_PATH}/images/icons/webtools_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/webtools.gif" name="webtools" width="47" height="46" border="0" alt="" id="webtools" /></a></div></td>
  </tr><tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="server_statistic.php" onmouseover="MM_swapImage('statistics','','{THEME_COLOR_PATH}/images/icons/statistics_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/statistics.gif" name="statistics" width="47" height="46" border="0" alt="" id="statistics" /></a></div></td>
  </tr><tr>
...
<!-- EDP: isactive_support -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="settings.php" onmouseover="MM_swapImage('settings','','{THEME_COLOR_PATH}/images/icons/settings_a.gif',1)" onmouseout="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/settings.gif" name="settings" width="47" height="46" border="0" alt="" id="settings" /></a></div></td>
  </tr><tr>
