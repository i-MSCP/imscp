...
Multiple webmails are now supported. You can install either no webmail, one webmail or many webmail at same time. You can
reconfigure list of webmail to install by running the following commands:
