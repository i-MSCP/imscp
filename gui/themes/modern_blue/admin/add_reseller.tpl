  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_user.jpg" width="85" height="62" align="absmiddle">{TR_ADD_RESELLER}</td>
            <td width="27" align="right" background="{THEME_COLOR_PATH}/images/content/table_background.jpg"><img src="{THEME_COLOR_PATH}/images/content/table_icon_close.jpg" width="27" height="62"></td>
          </tr>
          <tr>
            <td valign="top">
<form name="admin_add_reseller" method="post" action="add_reseller.php">
            <table width="750" cellpadding="5" cellspacing="5">
              ...
              <tr>
                ...
                <td class="content"> 
                  <input type="password" name="pass" value="{GENPAS}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="password" name="pass_rep" value="{GENPAS}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
             ...
             <!--
              ...
              <tr> 
                ...
                <td colspan="2"><table cellpadding="5" cellspacing="5" border="0" width="100%">
                  ...
                  <!-- BDP: rsl_ip_message -->
                  <tr>
                    <td colspan="4" class="title" nowrap align="center"><b>{MESSAGES_LABEL}</b></td>
                  </tr>
                  <!-- EDP: rsl_ip_message -->
                  <!-- BDP: rsl_ip_list -->
                  <tr>
              ...
              <tr>
                ...
                <td class="content"> 
                  <input type="text" name="customer_id" value="{CUSTOMER_ID}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="fname" value="{FIRST_NAME}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="lname" value="{LAST_NAME}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="firm" value="{FIRM}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="zip" value="{ZIP}" style="width:80px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="city" value="{CITY}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="country" value="{COUNTRY}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="street1" value="{STREET_1}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="street2" value="{STREET_2}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="phone" value="{PHONE}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input type="text" name="fax" value="{FAX}" style="width:210px" class="textinput">
                </td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
