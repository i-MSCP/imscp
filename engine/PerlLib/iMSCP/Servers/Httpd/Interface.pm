=head1 NAME
 ...
 iMSCP::Servers::Httpd::Interface - i-MSCP httpd server interface
...
package iMSCP::Servers::Httpd::Interface;
...
=item buildConfFile( $srcFile, $trgFile, [, \%moduleData = { } [, \%serverData [, \%parameters = { } ] ] ] )
 ...
 Param string $srcFile Absolute source filepath or source filepath relative to the i-MSCP httpd configuration directory
