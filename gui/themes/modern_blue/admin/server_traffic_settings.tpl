  ...
  <tr>
    ...
    <td align="right" background="{THEME_COLOR_PATH}/images/icons/icon_bcgr.gif" class="menu"><a href="../index.php" onMouseOver="MM_swapImage('logout','','{THEME_COLOR_PATH}/images/icons/logout_a.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/logout.gif" name="logout" width="36" height="36" border="0" id="logout"></a></td>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_traffic.jpg" width="85" height="62" align="absmiddle">{TR_SERVER_TRAFFIC_SETTINGS}</td>
            <td width="27" align="right" background="{THEME_COLOR_PATH}/images/content/table_background.jpg"><img src="{THEME_COLOR_PATH}/images/content/table_icon_close.jpg" width="27" height="62"></td>
          </tr>
          <tr>
            <td valign="top">
			<form name="admin_modify_server_traffic_settings" method="post" action="server_traffic_settings.php">
            <table width="100%" cellpadding="5" cellspacing="5">
              ...
              <tr>
                ...
                <td class="content"> 
                  <input name="max_traffic" type="text" class="textinput" id="max_traffic" style="width:170px" value="{MAX_TRAFFIC}">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
                ...
                <td class="content"> 
                  <input name="traffic_warning" type="text" class="textinput" id="traffic_warning" style="width:170px" value="{TRAFFIC_WARNING}">
                </td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td> 
