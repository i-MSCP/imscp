...
$g_pcltar_extension = substr(strrchr(basename(__FILE__), '.'), 1);
...
// NET2FTP
// Do not include the 2 other libraries again, they are already included from
// net2ftp's main.inc.php file
