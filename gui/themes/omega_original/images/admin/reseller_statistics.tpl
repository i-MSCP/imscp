                              ...
                              <td class="{ITEM_CLASS}" nowrap="nowrap" align="center"><b><a href="reseller_user_statistics.php?rid={RESELLER_ID}&amp;name={RESELLER_NAME}&amp;month={MONTH}&amp;year={YEAR}" title="{RESELLER_NAME}" class="link">{RESELLER_NAME}</a></b></td>
                                <td class="{ITEM_CLASS}" nowrap="nowrap" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td class="statsBar"><table border="0" cellspacing="0" cellpadding="0" align="left">
                                        <tr>
                                          <td class="statsBar"><img src="{THEME_COLOR_PATH}/images/bars/stats_progress.png" width="{TRAFF_PERCENT}" height="20" /></td>
                                        </tr>
                                    </table></td>
                                ...
                                <td class="{ITEM_CLASS}" nowrap="nowrap" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    <td class="statsBar"><table border="0" cellspacing="0" cellpadding="0" align="left">
                                        <tr>
                                          <td class="statsBar"><img src="{THEME_COLOR_PATH}/images/bars/stats_progress.png" width="{DISK_PERCENT}" height="20" /></td>
                                        </tr>
                                    </table></td>
                                    <td width="3"><img src="{THEME_COLOR_PATH}/images/bars/stats_right.png" width="3" height="20" /></td>
                                  </tr>
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              ...
                              <td><div align="left"><br />
                                      ...
                                      <!-- BDP: scroll_prev -->
                                      <a href="reseller_statistics.php?psi={PREV_PSI}&amp;month={MONTH}&amp;year={YEAR}"><img src="{THEME_COLOR_PATH}/images/icons/flip/prev.gif" width="20" height="20" border="0" alt="" /></a>
                                      <!-- EDP: scroll_prev -->
                                      <!-- BDP: scroll_next_gray -->
                                &nbsp;<img src="{THEME_COLOR_PATH}/images/icons/flip/next_gray.gif" width="20" height="20" border="0" alt="" />
                                <!-- EDP: scroll_next_gray -->
                                <!-- BDP: scroll_next -->
                                &nbsp;<a href="reseller_statistics.php?psi={NEXT_PSI}&amp;month={MONTH}&amp;year={YEAR}"><img src="{THEME_COLOR_PATH}/images/icons/flip/next.gif" width="20" height="20" border="0" alt="" /></a>
                                <!-- EDP: scroll_next -->
                              </div></td>
