...
$main::vhcs2_rqst_mngr = "$main::root_dir/engine/vhcs2-rqst-mngr";

$main::vhcs2_rqst_mngr_el = "$main::log_dir/vhcs2-rqst-mngr.el";
$main::vhcs2_rqst_mngr_stdout = "$main::log_dir/vhcs2-rqst-mngr.stdout";
$main::vhcs2_rqst_mngr_stderr = "$main::log_dir/vhcs2-rqst-mngr.stderr";

$main::vhcs2_dmn_mngr = "$main::root_dir/engine/vhcs2-dmn-mngr";

$main::vhcs2_dmn_mngr_el = "$main::log_dir/vhcs2-dmn-mngr.el";
$main::vhcs2_dmn_mngr_stdout = "$main::log_dir/vhcs2-dmn-mngr.stdout";
$main::vhcs2_dmn_mngr_stderr = "$main::log_dir/vhcs2-dmn-mngr.stderr";

$main::vhcs2_sub_mngr = "$main::root_dir/engine/vhcs2-sub-mngr";

$main::vhcs2_sub_mngr_el = "$main::log_dir/vhcs2-sub-mngr.el";
$main::vhcs2_sub_mngr_stdout = "$main::log_dir/vhcs2-sub-mngr.stdout";
$main::vhcs2_sub_mngr_stderr = "$main::log_dir/vhcs2-sub-mngr.stderr";

$main::vhcs2_als_mngr = "$main::root_dir/engine/vhcs2-als-mngr";

$main::vhcs2_als_mngr_el = "$main::log_dir/vhcs2-als-mngr.el";
$main::vhcs2_als_mngr_stdout = "$main::log_dir/vhcs2-als-mngr.stdout";
$main::vhcs2_als_mngr_stderr = "$main::log_dir/vhcs2-als-mngr.stderr";

$main::vhcs2_mbox_mngr = "$main::root_dir/engine/vhcs2-mbox-mngr";

$main::vhcs2_mbox_mngr_el = "$main::log_dir/vhcs2-mbox-mngr.el";
$main::vhcs2_mbox_mngr_stdout = "$main::log_dir/vhcs2-mbox-mngr.stdout";
$main::vhcs2_mbox_mngr_stderr = "$main::log_dir/vhcs2-mbox-mngr.stderr";

$main::vhcs2_serv_mngr = "$main::root_dir/engine/vhcs2-serv-mngr";

$main::vhcs2_serv_mngr_el = "$main::log_dir/vhcs2-serv-mngr.el";
$main::vhcs2_serv_mngr_stdout = "$main::log_dir/vhcs2-serv-mngr.stdout";
$main::vhcs2_serv_mngr_stderr = "$main::log_dir/vhcs2-serv-mngr.stderr";

#
# htuser manager variables.
#

$main::vhcs2_htuser_mngr = "$main::root_dir/engine/vhcs2-htuser-mngr";

$main::vhcs2_htuser_mngr_el = "$main::log_dir/vhcs2-htuser-mngr.el";
$main::vhcs2_htuser_mngr_stdout = "$main::log_dir/vhcs2-htuser-mngr.stdout";
...
$main::vhcs2_httpd_logs_mngr_stderr = "$main::log_dir/vhcs2-httpd-logs-mngr.stderr";

$main::vhcs2_ftp_acc_mngr_el = "$main::log_dir/vhcs2-ftp-acc-mngr.el";
$main::vhcs2_ftp_acc_mngr_stdout = "$main::log_dir/vhcs2-ftp-acc-mngr.stdout";
$main::vhcs2_ftp_acc_mngr_stderr = "$main::log_dir/vhcs2-ftp-acc-mngr.stderr";
    
$main::vhcs2_bk_task_el = "$main::log_dir/vhcs2-bk-task.el";

$main::vhcs2_srv_traff_el = "$main::log_dir/vhcs2-srv-traff.el";

$main::vhcs2_dsk_quota_el = "$main::log_dir/vhcs2-dsk-quota.el";
