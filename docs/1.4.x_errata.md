...
It is important to note that if default mail account are not protected and that
a customer turn a default mail account into a normal mail account, it will no
longer be seen as a default mail account.
