...
<tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
      <td class="menu"><div align="center"><a href="settings.php" onMouseOver="MM_swapImage('settings','','{THEME_COLOR_PATH}/images/icons/settings_a.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="{THEME_COLOR_PATH}/images/icons/settings_a.gif" name="settings" width="47" height="46" border="0" id="settings" /></a></div></td>
  </tr><tr>
