...
<table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%"  border="00" cellspacing="0" cellpadding="0">
			  ...
			  <!-- BDP: tickets_list -->
                <tr>
                  <td nowrap class="content3">
				   {TR_TICKET_URGENCY}: {URGENCY} <br>
				   {TR_TICKET_SUBJECT}: {SUBJECT}
				  </td>
                </tr>
               <!-- BDP: tickets_item -->
			    <tr>
                  <td nowrap class="content2">
				  <span class="content">{TR_TICKET_FROM}: {FROM}</span><br>
                ...
                <tr>
                  ...
                  <td valign="top"><form name="question_frm" method="post" action="view_ticket.php?ticket_id={ID}">
                      <table width="100%" cellspacing="5">
                        ...
                        <tr>
                          <td width="100">
						   <input name="Button" type="button" class="button" value="{TR_REPLY}" onClick="return sbmt(document.forms[0],'send_msg');">
                          </td>
                          <td width="383">
  ...
  <tr>
    <td height="71" background="{THEME_COLOR_PATH}/images/background_down.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
