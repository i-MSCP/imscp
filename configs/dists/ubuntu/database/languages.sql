...
('[New]', ''),
('[Re]', ''),
('</b> Address !<br>Edit reseller aborted!', ''),
...
('</b> Service can not be limited !<br>Specified number is smaller than <b>', ''),
...
('Add new user hosting plan', ''),
('Add On A Domain', ''),
('Add other domains to this account', ''),
('Add plan', ''),
('Add reseller', ''),
('Add SQL database', ''),
('Add SQL user', ''),
...
('Alias forward', ''),
('Alias list is empty!', ''),
('Alias list is empty! You can not add FTP accounts there!', ''),
('Alias list is empty! You can not add mail accounts!', ''),
('Alias mail', ''),
('Alias mails', ''),
('Alias name', ''),
...
('Apache logs', ''),
('Apply changes', ''),
('Are you sure you want to change the status of domain account?', ''),
...
('Button name', ''),
('Button target', ''),
('Can not connect as MySQL administrator!', ''),
('Can Not Connect As MySQL Administrator!', ''),
...
('Cancel', ''),
('Cancel order', ''),
('Cannot connect as MySQL administrator!', ''),
('Catch all', ''),
('Catch all account', ''),
...
('City', ''),
('Clear log', ''),
('Click Restore button and the system will restore last daily backup', ''),
('Close ticket', ''),
('Closed tickets', ''),
('Command to run:', ''),
('Company', ''),
...
('Group name', ''),
('Groups', ''),
('Has IP address that can not be managed from the destination reseller !<br>This user can not be moved!', ''),
...
('Protected area status should be OK if you want to delete it!', ''),
('Protected area status should be OK if you want to edit it!', ''),
...
('You have no users!', ''),
('You have no users.', ''),
('You have reached your domain limit.<br>You can not add more domains!', ''),
...
('You send email to your users successfully!', ''),
('Your Chart', ''),
