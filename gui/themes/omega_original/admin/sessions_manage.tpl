                    ...
                    <tr>
                      <td valign="top"><table width="100%" cellpadding="5" cellspacing="5">
                          ...
                          <tr>
                            ...
                            <td width="150" class="{ADMIN_CLASS}"><img src="{THEME_COLOR_PATH}/images/icons/delete.png" width="16" height="16" border="0" style="vertical-align:middle" alt="" /> <a href="{KILL_LINK}" class="link">{TR_DELETE}</a> </td>
                          </tr>
                          <!-- EDP: user_session -->
                      </table></td>
                      <td>&nbsp;</td>
