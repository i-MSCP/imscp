...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
    ...
    <body>
        ...
        <div class="body">
            <h2 class="users">{TR_DOMAIN_SUMMARY}</h2>
            <table>
                <tr>
                    <td colspan="2"><strong>{TR_DOMAIN_SUMMARY}</strong></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        {TR_REALLY_WANT_TO_DELETE_DOMAIN}<br /><br />
                            <input type="checkbox" value="1" name="delete" style="vertical-align: middle" />{TR_YES_DELETE_DOMAIN}
