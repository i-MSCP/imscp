			...
			<form name="reseller_add_host_plant_frm" method="post" action="hosting_plan_add.php">
					...
					<table>
						<tr>
							<td style="width:300px;">
								<label for="hp_name">{TR_TEMPLATE_NAME}</label></td>
							<td>
						...
						<tr>
							...
							<td>
								<textarea id="hp_description" name="hp_description" cols="40" rows="8">{HP_DESCRIPTION_VALUE}</textarea>
							</td>
						</tr>
						<tr>
							<td><label for="hp_sub">{TR_MAX_SUBDOMAINS}</label></td>
							<td>
								<input id="hp_sub" type="text" name="hp_sub" value="{TR_MAX_SUB_LIMITS}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_als">{TR_MAX_ALIASES}</label></td>
							<td>
								<input id="hp_als" type="text" name="hp_als" value="{TR_MAX_ALS_VALUES}" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input id="hp_mail" type="text" name="hp_mail" value="{HP_MAIL_VALUE}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_ftp">{TR_MAX_FTP}</label></td>
							<td>
								<input id="hp_ftp" type="text" name="hp_ftp" value="{HP_FTP_VALUE}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_sql_db">{TR_MAX_SQL}</label></td>
							<td>
								<input id="hp_sql_db" type="text" name="hp_sql_db" value="{HP_SQL_DB_VALUE}" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<input id="hp_sql_user" type="text" name="hp_sql_user" value="{HP_SQL_USER_VALUE}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_traff">{TR_MAX_TRAFFIC}</label></td>
							<td>
								<input id="hp_traff" type="text" name="hp_traff" value="{HP_TRAFF_VALUE}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_disk">{TR_DISK_LIMIT}</label></td>
							<td>
								<input id="hp_disk" type="text" name="hp_disk" value="{HP_DISK_VALUE}" />
							</td>
						</tr>
						<tr>
							<td>{TR_PHP}</td>
				...
				<fieldset>
					...
					<table>
						<tr>
							<td style="width:300px;">
								<label for="hp_price">{TR_PRICE}</label></td>
							<td>
						...
						<tr>
							...
							<td>
								<input name="hp_setupfee" type="text" id="hp_setupfee" value="{HP_SETUPFEE}" />
							</td>
						</tr>
						<tr>
							<td><label for="hp_value">{TR_VALUE}</label></td>
							<td>
								<input name="hp_value" type="text" id="hp_value" value="{HP_VELUE}" /><span class="legend">{TR_EXAMPLE}</span>
							</td>
						</tr>
						<tr>
							<td><label for="hp_payment">{TR_PAYMENT}</label></td>
							<td>
								<input name="hp_payment" type="text" id="hp_payment" value="{HP_PAYMENT}" />
							</td>
						</tr>
						<tr>
							<td>{TR_STATUS}</td>
				...
				<fieldset>
					...
					<table>
						...
						<tr>
							<td style="width:300px;"><label for="hp_tos">{TR_TOS_DESCRIPTION}</label></td>
							<td>
