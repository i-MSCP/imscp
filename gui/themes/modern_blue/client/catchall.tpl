  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_email.jpg" width="85" height="62" align="absmiddle">{TR_CATCHALL_MAIL_USERS}</td>
                ...
                <tr>
                  ...
                  <td valign="top"><table width="100%" cellspacing="7">
                    ...
                    <tr>
                      ...
                      <td nowrap class="{ITEM_CLASS}" align="center" width="200">
					  <!-- BDP: del_icon -->
