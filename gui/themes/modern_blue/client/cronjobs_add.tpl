            ...
            <table width="100%" cellpadding="5" cellspacing="5">
              ...
              <!-- EDP: page_message -->
			   <tr>
			     ...
			     <td colspan="4" class="content"><input name="name" type="text" class="textinput" id="name" style="width:170px"></td>
			     </tr>
			   <tr>
			     <td nowrap>&nbsp;</td>
			     <td nowrap class="content2">{TR_DESCRIPTION}</td>
			     <td colspan="4" class="content"><input name="description" type="text" class="textinput" id="description" style="width:170px"></td>
			     </tr>
			   <tr>
                <td nowrap>&nbsp;</td>
              ...
              <tr>
                <td width="20">&nbsp;</td> 
                <td colspan="5"> 
                  <input name="Submit" type="submit" class="button" value="  {TR_ADD}  ">&nbsp;&nbsp; <input name="Reset" type="reset" class="button" value="{TR_RESET}">
				  &nbsp;&nbsp; <input type="button" class="button" onClick="MM_goToURL('parent','cronjobs_overview.php');return document.MM_returnValue" value="{TR_CANCEL}"></td>
                </tr>
            </table>
