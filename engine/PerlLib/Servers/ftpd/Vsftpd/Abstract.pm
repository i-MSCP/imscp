=head1 NAME
 ...
 Servers::ftpd::vsftpd - i-MSCP VsFTPd Server abstract implementation
...
package Servers::ftpd::Vsftpd::Abstract;
...
use Class::Autouse qw/ :nostat iMSCP::Database iMSCP::Getopt Servers::sqld /;
use File::Temp;
use iMSCP::Config;
...
=item _init( )
 ...
 Return Servers::ftpd::Vsftpd::Abstract
