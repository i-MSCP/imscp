...
record, it will be automatically completed with your domain name (zone for which you add the record). For instance, if
you add a DNS resource record for the `test.tld` zone, and specify the following label for the `name` field:
