<?php
/* $Id: catalan-utf-8.inc.php 12640 2009-07-11 09:11:20Z lem9 $ */
...
$strCreateUserDatabasePrivileges = 'Atorgar tots els permissos a la base de dades &quot;%s&quot;';
...
$strReplicationStatusInfo = 'Aquest servidor MySQL treballa com a %s al procés de <b>replicació</b>. Per a més informació sobre l\'estat de replicació al servidor, vegeu la secció <a href="#replication">replicació</a>.';
...
$strSetupCheckConfigurationPermissions_name = 'Comprovar els permissos de l\'arxiu de configuració';
$strSetupClear = 'Netejar';
...
$strSetupConfirm_name = 'Confirmar consultes de DROP';
$strSetupDefaultCharset_desc = 'Joc de caracters predeterminat usat per a conversions';
$strSetupDefaultCharset_name = 'Joc de caracters predeterminat';
...
$strSetupExport_charset_name = 'Joc de caracters de l\'arxiu';
...
$strSetupExport_onserver_name = 'Desar al servidor';
...
$strSetupIgnoreMultiSubmitErrors_name = 'Ignorar errors d\'instruccions multiples';
...
$strSetupLeftDisplayLogo_desc = 'Mostrar el logo al marc esquerre';
$strSetupLeftDisplayLogo_name = 'Mostrar logo';
$strSetupLeftDisplayServers_desc = 'Mostrar servidor triat a dalt del marc esquerre';
$strSetupLeftDisplayServers_name = 'Mostrar tría de servidors';
...
$strSetupLeftFrameDBTree_name = 'Mostrar bases de dades en arbre';
...
$strSetupMaxTableList_desc = 'Màaxim nombre de taules mostrades a la llista';
...
$strSetupOBGzip_desc = 'utilitza la memòria intermèdia de sortida per GZip per incrementar la velocitat en transferències HTTP';
$strSetupOBGzip_name = 'Memòria intermèdia de sortida per GZip';
...
$strSetupPropertiesIconic_desc = 'Usar només icones, només text o bé ambdós';
$strSetupPropertiesIconic_name = 'Icones d\'operacions de taula';
$strSetupProtectBinary_desc = 'Desactivar l\'edició en camps tipus BLOB i BINARY';
$strSetupProtectBinary_name = 'Protegir camps binaris';
...
$strSetupRecodingEngine_desc = 'Selecciona quines funcions s\'usaràn per a conversions de jocs de caracters';
...
$strSetupServers_table_info_desc = 'Taula per descriure els camps a mostrar, deixa en blanc per desactivar; predeterminat: [kbd]pma_table_info[/kbd]';
...
$strSetupShowAll_name = 'Permetre mostrar totes les files';
$strSetupShowChgPassword_desc = 'Activar aixó no té efecte amb el mode d\'autenticació [kbd]config[/kbd] degut a que la contrasenya està inclosa al arxiu de configuració; aixó no limita la posibilñitat d\'executar la mateixa ordre directament';
$strSetupShowChgPassword_name = 'Mostrar formulari de canvi de contrasenya';
$strSetupShowCreateDb_name = 'Mostrar el formulari de creació de base de dades';
$strSetupShowForm = 'Mostrar formulari';
$strSetupShowFunctionFields_desc = 'Mostrar els camps de funcio en modes edició/inserció';
$strSetupShowFunctionFields_name = 'Mostrar camps de funció';
...
$strSetupShowTooltipAliasDB_name = 'Mostrar comentari de la base de dades en lloc del seu nom';
...
$strSetupShowTooltipAliasTB_name = 'Mostrar comentari de taula en lloc del seu nom';
...
$strSetupUseDbSearch_desc = 'Permetre cercar dins de tota la base de dades';
$strSetupUseDbSearch_name = 'Usar cerca de base de dades';
...
$strSetupVersionCheckLink = 'Comprovar darrera versió';
