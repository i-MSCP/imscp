          ...
          <tr>
            <td valign="top"><form name="admin_email_setup" method="post" action="circular.php">
              ...
              <tr>
                ...
                <td class="content"> 
                  <input type="text" name=msg_subject value="{MESSAGE_SUBJECT}" style="width:270px" class="textinput">
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td> 
                ...
                <td class="content"> 
                  <textarea name="msg_text" style="width:270px" class="textinput2" rows="8">{MESSAGE_TEXT}</textarea>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
