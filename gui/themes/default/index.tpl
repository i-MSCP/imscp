...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
    <head>
        ...
        /*<![CDATA[*/
            * {
            ...
            .i_lock {
                background-image:       url('/themes/default/images/login/i_lock.png');
            }
            ...
            li a.pma{
                background-image:       url('/themes/default/images/login/phpmyadmin.png');
            }

            li a.filemanager{
                background-image:       url('/themes/default/images/login/filemanager.png');
            }

            li a.webmail{
                background-image:       url('/themes/default/images/login/webmail.png');
            }
        /*]]>*/
        </style>
        <!--[if IE 6]>
    ...
    <body>
        <div id="wrapper">
            ...
            <!-- EDP: page_message -->
            <div id="center">
                <form name="login_frm" action="index.php" method="post" enctype="application/x-www-form-urlencoded">
                    <div>
                        <p><label for="uname">{TR_USERNAME}:</label>
