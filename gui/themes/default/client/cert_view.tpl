			<form name="cert_edit" method="post" action="cert_view.php?id={ID}&type={TYPE}">
				<table>
					...
					<tr>
						<td>
							<label for="key_cert">{TR_CERTIFICATE_KEY}</label>
						</td>
						<td>
							<textarea name="key_cert" id="key_cert" cols="35" rows="5" style="height:150px;">{KEY_CERT}</textarea>
						</td>
					</tr>
					<tr>
						<td>
							<label for="cert_cert">{TR_CERTIFICATE}</label>
						</td>
						<td>
							<textarea name="cert_cert" id="cert_cert" cols="35" rows="5" style="height:150px;">{CERT}</textarea>
						</td>
					</tr>
					<tr>
						<td>
							<label for="ca_cert">{TR_INTERM_CERTIFICATE}</label>
						</td>
						<td>
							<textarea name="ca_cert" id="ca_cert" cols="35" rows="5" style="height:150px;">{CA_CERT}</textarea>
						</td>
					</tr>
				</table>
				<div class="buttons">
