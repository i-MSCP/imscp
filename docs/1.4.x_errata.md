...
`.well-known` directory will be automatically created on new domain, alias or subdomain creation. This direcetory is
created inside of the site document root: `./htdocs/.well-known`.

Note that for existent domains, you have to create that directory manually if needed.
