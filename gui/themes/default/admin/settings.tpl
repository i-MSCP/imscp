            ...
            <div style="padding: 0">
                ...
                <div class="odd">
                    <div class="left"><label
                            for="lostpassword_timeout">{TR_LOSTPASSWORD_TIMEOUT}</label></div>
                    <div class="right">
            ...
            <div style="padding: 0">
                ...
                <div class="odd">
                    <div class="left"><label
                            for="max_subdnames_labels">{TR_MAX_SUBDNAMES_LABELS}</label></div>
                    <div class="right">
            ...
            <div style="padding: 0">
                ...
                <div class="odd">
                    ...
                    <div class="right">
                        <input name="domain_rows_per_page" id="domain_rows_per_page" type="text"
                               value="{DOMAIN_ROWS_PER_PAGE}" maxlength="3"/>
                    </div>
                </div>
                <div class="even">
                ...
                <div class="odd">
                    <div class="left"><label
                            for="prevent_external_login_admin">{TR_PREVENT_EXTERNAL_LOGIN_ADMIN}</label></div>
                    <div class="right">
