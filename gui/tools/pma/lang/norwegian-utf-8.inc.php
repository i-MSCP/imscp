<?php
/* $Id: norwegian-utf-8.inc.php 12494 2009-05-25 08:11:32Z helmo $ */
...
$strSetupServers_pmadb_desc = 'Database brukt for relasjoner, bokmerker og PDF egenskaper. Se [a@http://wiki.phpmyadmin.net/pma/pmadb]pmadb[/a] for komplett informasjon. La stå blank for å slå av. Standard: [kbd]phpmyadmin[/kbd]';
...
$strSetupServers_bookmarktable_desc = 'La stå tom for ingen [a@http://wiki.phpmyadmin.net/pma/bookmark]bokmerke[/a]støtte, standard: [kbd]pma_bookmark[/kbd]';
$strSetupServers_relation_name = 'Relasjonstabell';
$strSetupServers_relation_desc = 'La stå tom for ingen [a@http://wiki.phpmyadmin.net/pma/relation]relasjonslink[/a]støtte, default: [kbd]pma_relation[/kbd]';
