...
$net2ftp_messages["To set all permissions to the same values, enter those permissions and click on the button \"Set all permissions\""] = "Aby zmieniæ wszytkie uprawnienia na takie same warto¶ci, wprowad¼ te uprawnienia i naci¶nij przycisk \"Ustaw wszytkie uprawnienia\"";
