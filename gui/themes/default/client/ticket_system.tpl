		...
		<div class="body">
			...
			<!-- BDP: tickets_list -->
				...
				<table>
					...
					<tfoot>
						<tr>
							<td colspan="5"><input name="Submit" type="submit" class="button" onclick="MM_goToURL('parent','ticket_delete.php?delete=open');return document.MM_returnValue" value="{TR_DELETE_ALL}" /></td>
						</tr>
					</tfoot>
					<tbody>
						<!-- BDP: tickets_item -->
