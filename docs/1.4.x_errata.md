...
i-MSCP bind9 template files were updated. Thus, if you use your own template files, don't forget to sync them.

### Zone files format

DNS zone files are now stored in binary format for faster loading.
