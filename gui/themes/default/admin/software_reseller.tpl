...
<table>
	...
	<tr>
		<td colspan="7">
			<div class="warning">{NO_SOFTWAREDEPOT}</div>
		</td>
	</tr>
	...
	<tr>
		...
		<td style="text-align: center"><a href="{IMPORT_LINK}" class="icon i_app_download"
										  onClick="return action_import()">{TR_IMPORT}</a></td>
		<td style="text-align: center"><a href="{DELETE_LINK}" class="icon i_delete"
...
<table>
	...
	<tr>
		<td colspan="5">
			<div class="warning">{NO_RESELLER}</div>
		</td>
	</tr>
