...
<form name="passwordUpdate" method="post" action="password_update.php">
	<table class="firstColFixed">
		...
		<tr>
			...
			<td colspan="2"><input id="current_password" name="current_password" type="password" value=""
								   autocomplete="off"/></td>
		</tr>
		<tr>
			<td><label for="password">{TR_PASSWORD}</label></td>
			<td style="width: 235px;"><input name="password" id="password" type="password" value="" autocomplete="off"/>
			</td>
			<td>
		...
		<tr>
			...
			<td colspan="2"><input name="password_confirmation" id="password_confirmation" type="password" value=""
								   autocomplete="off"/></td>
		</tr>
		</tbody>
	</table>
