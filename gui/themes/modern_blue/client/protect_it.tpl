  ...
  {MENU}
    <!-- Menu end -->
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="62" align="left" background="{THEME_COLOR_PATH}/images/content/table_background.jpg" class="title"><img src="{THEME_COLOR_PATH}/images/content/table_icon_htaccess.jpg" width="85" height="62" align="absmiddle">{TR_HTACCESS}</td>
          ...
          <tr>
            ...
            <table width="100%" cellpadding="5" cellspacing="5">
              ...
              <tr>
                ...
                <td align="center" nowrap class="content">
				<select name="users[]" multiple size="5" class="textinput2">
				   <!-- BDP: user_item -->
                ...
                <td align="center" nowrap class="content">
				<select name="groups[]" multiple size="5" class="textinput2">
				  <!-- BDP: group_item -->
              ...
              <tr>
                <td nowrap>&nbsp;</td>
                <td colspan="2" nowrap>
				<input name="Button" type="button" class="button" value="{TR_PROTECT_IT}" onClick="return sbmt(document.forms[0],'protect_it');">
				&nbsp;&nbsp;&nbsp;
				<!-- BDP: unprotect_it -->
