...
sub preinstall
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdPreInstall', 'apache_itk');
...
sub install
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdInstall', 'apache_itk');
...
sub postinstall
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdPostInstall', 'apache_itk');

	$self->{'start'} = 'yes';

	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdPostInstall', 'apache_itk');
...
sub enableSite
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdEnableSite', \$sites);
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdEnableSite', $sites);
...
sub disableSite
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdDisableSite', \$sites);
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdDisableSite', $sites);
...
sub enableMod
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdEnableMod', \$mod);
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdEnableMod', $mod);
...
sub disableMod
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdDisableMod', \$mod);
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdDisableMod', $mod);
...
sub start
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdStart');
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdStart');
...
sub stop
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdStop');
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdStop');
...
sub restart
{
	...
	$rs = iMSCP::HooksManager->getInstance()->trigger('beforeHttpdRestart');
	...
	$rs |= iMSCP::HooksManager->getInstance()->trigger('afterHttpdRestart');
...
sub getTraffic
{
	...
	iMSCP::HooksManager->getInstance()->trigger('beforeHttpdGetTraffic') and return 0;
	...
	iMSCP::HooksManager->getInstance()->trigger('afterHttpdGetTraffic') and return 0;
