			...
			<form name="reseller_add_host_plant_frm" method="post" action="hosting_plan_add.php">
				<table class="firstColFixed">
					...
					<tr>
						...
						<td><input id="hp_name" type="text" name="hp_name" class="inputTitle" value="{HP_NAME_VALUE}"/></td>
					</tr>
					<tr>
				...
				<table class="firstColFixed">
					...
					<tr>
						...
						<td><input name="hp_value" type="text" id="hp_value" value="{HP_VELUE}"/><span
								class="legend">{TR_EXAMPLE}</span></td>
					</tr>
					<tr>
