<?php
/* $Id: italian-utf-8.inc.php 11564 2008-09-07 11:43:11Z lem9 $ */
 ...
 * Revised by:    "Luca Rebellato" <rebeluca at users.sourceforge.net>  2008-08-26
 */
...
$strAccessDeniedCreateConfig = 'La ragione di questo &egrave; che probabilmente non hai creato alcun file di configurazione. Potresti voler usare %1$ssetup script%2$s per crearne uno.';
...
$strAnIndex = 'Un indice &egrave; stato aggiunto in %s';
$strAnyHost = 'Qualsiasi host';
$strAny = 'Qualsiasi';
$strAnyUser = 'Qualsiasi utente';
$strApproximateCount = 'Pu&ograve; essere approssimato. Vedere FAQ 3.11';
$strAPrimaryKey = 'Una chiave primaria &egrave; stata aggiunta in %s';
$strArabic = 'Arabo';
$strArmenian = 'Armeno';
...
$strBookmarkDeleted = 'Il bookmark &egrave; stato cancellato.';
...
$strBrowse = 'Mostra';
$strBufferPoolActivity = 'Attivit&agrave; del Buffer Pool';
...
$strCardinality = 'Cardinalit&agrave;';
...
$strCompressionWillBeDetected = 'Il tipo di compressione del file importato sar&agrave; automaticamente rilevato da: %s';
$strConfigDefaultFileError = 'Non posso leggere la configurazione da: "%1$s"';
$strConfigFileError = 'phpMyAdmin non riesce a leggere il file di configurazione!<br />Questo pu&ograve; accadere se il php trova un parse error in esso oppure il php non trova il file.<br />Richiamate il file di configurazione direttamente utilizzando il link sotto e leggete il/i messaggio/i di errore del php che ricevete. Nella maggior parte dei casi ci sono un apostrofo o una virgoletta mancanti.<br />Se ricevete una pagina bianca, allora &egrave; tutto a posto.';
...
$strCopy = 'Copia';
$strCopyDatabaseOK = 'Il Database %s &egrave; stato copiato in %s';
$strCopyTable = 'Copia la tabella nel (database<b>.</b>tabella):';
$strCopyTableOK = 'La tabella %s &egrave; stata copiata su %s.';
$strCopyTableSameNames = 'Impossibile copiare la tabella su se stessa!';
$strCouldNotKill = 'phpMyAdmin non &egrave; in grado di terminare il thread %s. Probabilmente &egrave; gi&agrave; stato terminato.';
$strCreate = 'Crea';
...
$strDatabaseEmpty = 'Il nome del DataBase &egrave; vuoto!';
$strDatabaseExportOptions = 'Opzioni di esportazione del database';
$strDatabaseHasBeenCreated = 'Il dtabase %1$s &egrave; stato creato.';
$strDatabaseHasBeenDropped = 'Il Database %s &egrave; stato eliminato.';
...
$strDefaultEngine = '%s &egrave; il motore di memorizzazione predefinito su questo server MySQL.';
...
$strDeleteAndFlushDescr = 'Questa &egrave; la vita pi&ugrave; giusta, ma il caricamento dei privilegi pu&ograve; durare qualche secondo.';
$strDeleted = 'La riga &egrave; stata cancellata';
$strDelete = 'Elimina';
...
$strDelOld = 'La Pagina corrente contiene Riferimenti a Tabelle che non esistono pi&ugrave;. Volete cancellare questi Riferimenti?';
...
$strDumpSaved = 'Il dump &egrave; stato salvato sul file %s.';
...
$strEnd = 'Fine';
$strEndRaw = 'FINE RAW';
$strEngineAvailable = '%s &egrave; disponibile su questo server MySQL.';
$strEngineDisabled = '%s &egrave; stato disabilitato su questo server MySQL.';
$strEngines = 'Motori';
...
$strErrorRelationExists = 'Errore: relazione gi&agrave; esistente.';
...
$strField = 'Campo';
$strFieldHasBeenDropped = 'Il campo %s &egrave; stato eliminato';
...
$strFileAlreadyExists = 'Il file %s esiste gi&agrave; sul server: prego, cambiare nome del file o selezionare l\'opzione "sovrascrivi".';
$strFileCouldNotBeRead = 'Il file non pu&ograve; essere letto';
$strFileNameTemplateDescriptionDatabase = 'nome database';
$strFileNameTemplateDescription = 'Questo valore &egrave; interpretato usando %1$sstrftime%2$s: in questo modo puoi usare stringhe di formattazione per le date/tempi. Verranno anche aggiunte le seguenti trasformazioni: %3$s. Il testo rimanente rester&agrave; invariato.';
...
$strHandler = 'Handler';
$strHasBeenAltered = '&egrave; stato modificato.';
...
$strHostEmpty = 'Il nome di host &egrave; vuoto!';
$strHost = 'Host';
...
$strIndexHasBeenDropped = 'L\'indice %s &egrave; stato eliminato';
$strIndex = 'Indice';
...
$strInsecureMySQL = 'Il file di configurazione in uso contiene impostazioni (root con nessuna password) che corrispondono ai privilegi dell\'account MySQL predefinito. Un server MySQL funzionante con queste impostazioni &egrave; aperto a intrusioni, e si dovrebbe realmente riparare a questa falla nella sicurezza.';
$strInsertAsNewRow = 'Inserisci come nuova riga';
$strInsertedRowId = 'Inserita riga id: %1$d';
$strInsert = 'Inserisci';
$strInterface = 'Interfacce';
$strInternalAndForeign = 'Una relazione interna non %&egrave; necessaria, quando una corrispondente relazione FOREIGN KEY esiste.';
...
$strInvalidRowNumber = '%d non &egrave; un numero valido di righe.';
...
$strKill = 'Rimuovi';
$strKnownExternalBug = 'La %s funzionalit&agrave; &egrave; affetta da un bug noto, vedi %s';
$strKorean = 'Coreano';
...
$strMbExtensionMissing = 'L\'estensione PHP mbstring non &egrave; stata trovata e sembra che si stia utilizzando un set di caratteri multibyte. Senza l\'estensione mbstring, phpMyAdmin non &egrave; in grado di dividere correttamente le stringhe di caratteri e questo pu&ograve; portare a risultati inaspettati.';
$strMbOverloadWarning = 'Avete abilitato mbstring.func_overload nella configurazione del PHP. Questa opzione &egrave; incompatibile con phpMyAdmin e potrebbe causare la corruzione di alcuni dati!';
...
$strMIME_nodescription = 'Nessuna descrizione &egrave; disponibile per questa trasformazione.<br />Prego, chiedere all\'autore cosa %s faccia.';
...
$strMIME_transformation_options_note = 'Prego, immettere i valori per le opzioni di trasformazioneutilizzando questo formato: \'a\', 100, b,\'c\'...<br />Se c\'&egrave; la necessit&agrave; di immettere un backslash ("\") o un apostrofo ("\'") tra questi valori, essi vanno backslashati (per es. \'\\\\xyz\' or \'a\\\'b\').';
...
$strMyISAMDataPointerSizeDesc = 'Dimensione del puntatore predefinito in Bytes, che deve essere usata da CREATE TABLE per le tabelle MyISAM quando non &egrave; stata specificata l\'opzione MAX_ROWS.';
$strMyISAMDataPointerSize = 'Domensione del puntatore dati';
$strMyISAMMaxExtraSortFileSizeDesc = 'Se il file temporaneo &egrave; usato per la creazione veloce di un indice MyISAM, occuperebbe pi&ugrave; spazio dell\'utilizzo del metodo key cache con la quantit&agrave; ivi specificata: perci&ograve; si deve prediligere il metodo key cache.';
$strMyISAMMaxExtraSortFileSize = 'Dimensione massima per i file temporanei nella creazione di un indice';
$strMyISAMMaxSortFileSizeDesc = 'La dimensione massima dei file temporanei MySQL pu&ograve; essere utilizzata nella rigenerazione di un indice MyISAM (durante un REPAIR TABLE, ALTER TABLE, o LOAD DATA INFILE).';
$strMyISAMMaxSortFileSize = 'Dimensione massima dei file temporanei di ordinamento';
$strMyISAMRecoverOptionsDesc = 'La modalit&agrave; di irppristino automatico di tabelle MyISAM corrotte, come impostato tramite l\'opzione di lan cio del server --myisam-recover.';
$strMyISAMRecoverOptions = 'Modalit&agrave; di ripristino automatico';
$strMyISAMRepairThreadsDesc = 'Se questo valore &egrave; maggiore di 1, gli indici della tabella MyISAM vengono creati in parallelo (ogni indice nel suo thread) durante il processo di ordinamento Repair by.';
...
$strName = 'Nome';
$strNext = 'Prossimo';
$strNoActivity = 'Nessuna attivit&agrave; da %s secondi o pi&ugrave;, si prega di autenticarsi nuovamente';
$strNoDatabases = 'Nessun database';
$strNoDatabasesSelected = 'Nessun database selezionato.';
$strNoDataReceived = 'Non sono stati ricevuti dati da importare. O non &egrave; stato indicato alcun nome file, oppure &egrave; stato superata la dimensione massima consentita per il file, impostata nella configurazione di PHP. Vedi FAQ 1.16.';
$strNoDescription = 'nessuna Description';
$strNoDetailsForEngine = 'Non &egrave; disponibile nessuna informazione dettagliata sullo stato di questo motore di memorizzazione.';
...
$strNotNumber = 'Questo non &egrave; un numero!';
$strNotOK = 'non OK';
...
$strPasswordChanged = 'La password per l\'utente %s &egrave; cambiata con successo.';
$strPasswordEmpty = 'La password &egrave; vuota!';
$strPasswordHashing = 'Password Hashing';
$strPasswordNotSame = 'La password non coincide!';
$strPassword = 'Password';
$strPBXTCheckpointFrequencyDesc = 'L\'ammontare dei dati scritti sul log delle trasazioni, prima che sia eseguito un checkpoint. Il valore di default &egrave; 24MB.';
...
$strPBXTDataLogThresholdDesc = 'La dimensione massima di un file con i log. Il valore di default &egrave; 64MB. PBXT pu&ograve; creare un massimo di 32000 log dei dati, che sono usati da tutte le tabelle. Il valore pu&ograve; essere incrementato per aumentare la dimensione massima dei dati che possono essere memorizzati complessivamente nel database.';
$strPBXTDataLogThreshold = 'Dimensione del log dei dati';
$strPBXTGarbageThresholdDesc = 'La percentuale di dati "spazzatura" in un file di log prima che questo debba essere compattato. Il valore deve essere compreso tra 1 e 99. Il valore di default &egrave; 50.';
$strPBXTGarbageThreshold = 'Dimensione del cestino';
$strPBXTIndexCacheSizeDesc = 'This is the amount of memory allocated to the index cache. Il valore di default &egrave; 32MB. La memoria allocata qui &egrave; usata solo per la cache delle pagine di indice.';
$strPBXTIndexCacheSize = 'Dimensione cache degli indici';
$strPBXTLogBufferSizeDesc = 'La dimensione del buffer usata quando si scrive un log dei dati. Il valore di default &egrave; 256MB. Il motore allora un buffer per ciascun thread, ma solo se &egrave; necessario scrivere un log dei dati.';
$strPBXTLogBufferSize = 'Dimensione del buffer dei log';
$strPBXTLogCacheSizeDesc = 'L\'ammontare di memoria allocata per la cache del log delle trasazioni. Il valore di default &egrave; 16MB.';
$strPBXTLogCacheSize = 'Dimensione cache dei log';
$strPBXTLogFileCountDesc = 'Questo &egrave; il numero dei file di log della trasazioni (pbxt/system/xlog*.xt) che il sistema conserva. Se il numero dei log &egrave; superiore i file pi&ugrave; sono cancellati, altrimenti vengono rinominati e gli viene assegnato il numero pi&ugrave; alto.';
$strPBXTLogFileCount = 'Numero dei file di log';
$strPBXTLogFileThresholdDesc = 'La dimensione del log delle trasazioni prima di un rollover, quando viene creato un nuovo file. Il valore di default &egrave; 16MB.';
...
$strPBXTTransactionBufferSizeDesc = 'La dimensione del buffer globale dei log di trasazione (il motore alloca 2 buffer di questa dimensione). Il valore di default &egrave; 1MB.';
...
$strPrimaryKeyHasBeenDropped = 'La chiave primaria &egrave; stata eliminata';
...
$strPrivDescMaxConnections = 'Limita il numero di nuove connessioni che un utente pu&ograve; aprire in un\'ora.';
$strPrivDescMaxQuestions = 'Limita il numero di query che un utente pu&ograve; mandare al server in un\'ora.';
$strPrivDescMaxUpdates = 'Limita il numero di comandi che possono cambiare una tabella o un database che un utente pu&ograve; eseguire in un\'ora.';
$strPrivDescMaxUserConnections = 'Limite di connessioni simultanee che un utente pu&ograve; fare.';
...
$strPrivDescSuper = 'Permette altre connessioni, anche se &egrave; stato raggiunto il massimo numero di connessioni; Necessario per molte operazioni di amministrazione come il settaggio di variabili globali o la cancellazione dei threads di altri utenti.';
...
$strRenameDatabaseOK = 'Il DataBase %s &egrave; stato rinominato in %s';
$strRenameTableOK = 'La tabella %s &egrave; stata rinominata %s';
...
$strRowsModeOptions = ' in modalit&agrave; %s e ripeti gli headers dopo %s celle ';
...
$strSearchType = 'Trova:';
$strSecretRequired = 'Adesso c\'&egrave; bisogno di una password per il file di configurazione (blowfish_secret).';
...
$strSetEnumVal = 'Se il tipo di campo &egrave; "enum" o "set", immettere i valori usando il formato: \'a\',\'b\',\'c\'...<br />Se comunque dovete mettere dei backslash ("\") o dei single quote ("\'") davanti a questi valori anteporre un "\" (per esempio \'\\\\xyz\' o \'a\\\'b\').';
...
$strShowHideLeftMenu = 'Mostra/nascondi il men&ugrave; di sinistra';
...
$strShowStatusCreated_tmp_disk_tablesDescr = 'Il numero delle tabelle temporanee create automaticamente sul disco dal server mentre esegue i comandi. Se il valore Created_tmp_disk_tables &egrave; grande, potresti voler aumentare il valore tmp_table_size, per fare im modo che le tabelle temporanee siano memory-based anzich&egrave; disk-based.';
...
$strShowStatusDelayed_insert_threadsDescr = 'Il numero di processi INSERT DELAYED in uso. Ciascuna tabella su cui &egrave; usato INSERT DELAYED occupa un thread.';
...
$strShowStatusHandler_deleteDescr = 'Il numero di volte in cui una riga &egrave; stata cancellata da una tabella.';
$strShowStatusHandler_discoverDescr = 'Il server MySQL pu&ograve; chiedere al motore di storage NDB Cluster se conosce una tabella sulla base di un nome dato. Questo &egrave; chaiamto discovery. Handler_discover indica il numero di volte che una tabella &egrave; stata trovata.';
$strShowStatusHandler_read_firstDescr = 'Il numero di volte che il primo valore &egrave; stato letto da un indice. Se &egrave; troppo alto &egrave; probabile che il server stia facendo molte scansioni complete degli indici; per esempio, SELECT col1 FROM foo, assumento che col1 sia indicizzata.';
$strShowStatusHandler_read_keyDescr = 'Il numero di richieste per leggere una riga basata su di una chiave. Se &egrave; alta, &egrave; un buon indice che le tue query e le tue tabelle sono correttamente indicizzate.';
$strShowStatusHandler_read_nextDescr = 'Il numero di richieste per leggere la riga successiva nell\'ordine delle chiavi. Questo valore &egrave; incrementato se stai facendo una query su di una colonna indice con un range costante, oppure se stai facendo una scansione degli indici.';
$strShowStatusHandler_read_prevDescr = 'Il numero di richieste per leggere la riga precedente nell\'ordine delle chiavi. Questo metodo di lettura &egrave; principalmente utilizzato per ottimizzare ORDER BY ... DESC.';
$strShowStatusHandler_read_rndDescr = 'Il numero di richieste per leggere una riga basata su una posizione fissa. Questo valore &egrave; alto se stai facendo molte richieste che richiedono un ordinamento dei risultati. Probabilmente hai molte query che che richiedono a MySQL di leggere l\'intera tabella oppure ci sono dei joins che non usano le chiavi correttamente.';
$strShowStatusHandler_read_rnd_nextDescr = 'Il numero di richieste per leggere la riga successiva in un file di dati. Questo valore &egrave; alto se stai facendo molte scansioni della tabella. Generalmente &egrave; un segnale che le tue tabelle non sono correttamente indicizzate, o che le query non sono state scritte per trarre vantaggi dagli indici che hai.';
...
$strShowStatusInnodb_buffer_pool_pages_miscDescr = 'Il numero di pagine occupate perch&egrave; sono state allocate per amministrazione, come row locks o per hash index adattivi. Questo valore pu&ograve; essere calcolato come Innodb_buffer_pool_pages_total - Innodb_buffer_pool_pages_free - Innodb_buffer_pool_pages_data.';
...
$strShowStatusInnodb_buffer_pool_readsDescr = 'Il numero di richieste logiche che InnoDB non pu&ograve; soddisfare dal buffer pool e che devono fare una lettura di una pagina singola.';
$strShowStatusInnodb_buffer_pool_wait_freeDescr = 'Normalmente le sritture nel buffer pool InnoDB vengono effettuate in background. Tuttavia se &egrave; necessario leggere o creare una pagina, e non sono disponibile pagine pulite &egrave; necessario attendere che le pagine siano aggiornate prima. Questo contatore conta le istanze di queste attese. Se la dimesione del buffer pool &egrave; stata settata correttamente questo valore dovrebbe essere basso.';
...
$strShowStatusInnodb_data_readDescr = 'La quantit&agrave; di dati letti fino ad ora, in bytes.';
...
$strShowStatusInnodb_data_writtenDescr = 'La quantit&agrave; di dati scritti fino ad ora, in bytes.';
...
$strShowStatusInnodb_log_waitsDescr = 'Il numero di attese che abbiamo avuto perch&egrave; il buffer di log era troppo piccolo e abbiamo duvuto attendere che fosse aggiornato prima di continuare.';
...
$strShowStatusKey_blocks_unusedDescr = 'Il numero di blocchi non usati nella cache chiave. Puoi usare questo valore per determinare quanta cache chiave &egrave; in uso.';
$strShowStatusKey_blocks_usedDescr = 'Il numero di blocchi usati nella cache chiave. The number of used blocks in the key cache. Questo valore &egrave; un\'importante segnale che indica il numero massimo di blocchi che sono stati in uso contemporaneamente.';
$strShowStatusKey_read_requestsDescr = 'Il numero di richieste per le ggere un blocco chiave dalla cache.';
$strShowStatusKey_readsDescr = 'Il numero di letture fisiche dal disco di un blocco chiave. Se Key_reads &egrave; grande allora il valore key_buffer_size &egrave; probabilmente troppo piccolo. IIl rapporto di cache miss rate pu&ograve; essere calcolato come Key_reads/Key_read_requests.';
...
$strShowStatusLast_query_costDescr = 'Il costo totale dell\'ultima query compilata cos&igrave; come computato dall\'ottimizzatore delle query. Utile per comparare il costo di differenti query per la stessa operazione di query. Il valore di default &egrave; 0, che significa che nessuna query &egrave; stata ancora compilata.';
$strShowStatusNot_flushed_delayed_rowsDescr = 'In numero di righe in attesa di essere scritte nella coda INSERT DELAYED.';
$strShowStatusOpened_tablesDescr = 'Il numero di tabelle che sono state aperte. Se il valore opened_tables &egrave; grande, probabilmente il valore di table cache &egrave; troppo piccolo.';
...
$strShowStatusQcache_lowmem_prunesDescr = 'Il numero di query che sono state rimosse dalla cache per liberare memoria per la cache di nuove query. Questa informazione pu&ograve; aiutarti per parametrare la dimensione della cache delle query. La cache delle query usa una strategia di "meno usate recentemente" (LRU - least recently used) per decidere quali query rimuovere dalla cache.';
$strShowStatusQcache_not_cachedDescr = 'Il numero di query non in cache (impossibilit&agrave; di inserirle nella cache oppure non inserite per i settaggi del parametro query_cache_type).';
...
$strShowStatusSelect_full_joinDescr = 'Il numero di joins che non usano gli indici. (Se questo valore non &egrave; 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
...
$strShowStatusSelect_range_checkDescr = 'Il numero di joins senza chiavi che controllano per l\'uso di una chiave dopo ogni riga. (Se questo valore non &egrave; 0, dovresti controllare attentamente gli indici delle tue tabelle.)';
$strShowStatusSelect_rangeDescr = 'Il numero di joins che usano un range sulla prima tabella. (Non &egrave;, solitamente, un valore critico anche se &egrave; grande.)';
...
$strShowStatusSlave_runningDescr = 'Questa chiave &egrave; ON se questo &egrave; un server slave connesso ad un server master.';
$strShowStatusSlow_launch_threadsDescr = 'Numero di processi che hanno impiegato pi&ugrave; di "slow_launch_time" secondi per partire.';
$strShowStatusSlow_queriesDescr = 'Numero di query che hanno impiegato pi&ugrave; di "long_query_time" seconds.';
$strShowStatusSort_merge_passesDescr = 'Il numero di fusioni passate all\'algoritmo di ordianemento che sono state fatte. Se questo valore &egrave; grande, dovresti incrementare la variabile di sistema sort_buffer_size.';
...
$strShowStatusTable_locks_immediateDescr = 'Il numero di volte che un table lock &egrave; stato eseguito immediatamente.';
$strShowStatusTable_locks_waitedDescr = 'Il numero di volte che un table lock &egrave; stato eseguito immediatamente ed era necessaria un\'attesa. Se &egrave; alto, potresti avere dei problemi con le performance, dovresti prima ottimizzare le query, oppure sia utilizzare le repliche, sia dividere le tabelle.';
$strShowStatusThreads_cachedDescr = 'Il numero dei processi nella cache dei processi. L\'hit rate della cache pu&ograve; essere calcolato come processi_creati/connessioni. Se questo valore &egrave; rosso devi aumentare la tua thread_cache_size.';
$strShowStatusThreads_connectedDescr = 'Il numero di connessioni correntemente aperte.';
$strShowStatusThreads_createdDescr = 'Il numero di processi creati per gestire le connessioni. Se Threads_created &egrave; grosso, devi probabilmente aumentare il valore thread_cache_size. (Normalmente questo non fornisce un significatico incremento delle performace se hai una buona implementazione dei processi.)';
...
$strSocketProblem = '(o il socket del server locale MySQL non &egrave; correttamente configurato)';
...
$strSQLCompatibility = 'Modo di compatibilit&agrave; SQL';
$strSQLExportType = 'Tipo di esportazione';
$strSQLParserBugMessage = 'C\'&egrave; la possibilit&agrave; che ci sia un bug nel parser SQL. Per favore, esaminate la query accuratamente, e controllate che le virgolette siano corrette e non sbagliate. Altre possibili cause d\'errori possono essere che si stia cercando di uploadare un file binario al di fuori di un\'area di testo virgolettata. Si pu&ograve; anche provare la query MySQL dalla riga di comando di MySQL. L\'errore qui sotto restituito dal server MySQL, se ce n\'&egrave; uno, pu&ograve; anche aiutare nella diagnostica del problema. Se ci sono ancora problemi, o se il parser SQL di phpMyAdmin sbaglia quando invece l\'interfaccia a riga di comando non mostra problemi, si pu&ograve; ridurre la query SQL in ingresso alla singola query che causa problemi, e inviare un bug report con i dati riportati nella sezione CUT qui sotto:';
$strSQLParserUserError = 'Pare che ci sia un errore nella query SQL immessa. L\'errore del server MySQL mostrato qui sotto, se c\'&egrave;, pu&ograve; anche aiutare nella risoluzione del problema';
...
$strSubmit = 'Invia';
$strSuccess = 'La query &egrave; stata eseguita con successo';
...
$strTableAlreadyExists = 'La tabella %s esiste gi&agrave;!';
$strTableAlteredSuccessfully = 'La tabella %1$s &egrave; gi&agrave; stata modificata con successo';
$strTableComments = 'Commenti sulla tabella';
$strTableEmpty = 'Il nome della tabella &egrave; vuoto!';
$strTableHasBeenCreated = 'La tabella %1$s &egrave; stata creata.';
$strTableHasBeenDropped = 'La tabella %s &egrave; stata eliminata';
$strTableHasBeenEmptied = 'La tabella %s &egrave; stata svuotata';
$strTableHasBeenFlushed = 'La tabella %s &egrave; stata inizializzata';
...
$strTextAreaLength = ' A causa della sua lunghezza,<br /> questo campo non pu&ograve; essere modificato ';
...
$strThreads = 'Processi';
$strThreadSuccessfullyKilled = 'Il thread %s &egrave; stato terminato con successo.';
$strTimeoutInfo = 'Una precedente importazione &egrave; entrata in timeout, dopo un nuovo inoltro riprender&agrave; dalla posizione: %d.';
$strTimeoutNothingParsed = 'Nell\'ultima esecuzione nessun dato &egrave; stato processato, questo, solitamente, vuole dire che che phpMyAdmin non &egrave; in grado di ultimare l\'operazione fino a che non verr&agrave; aumentato il parametro php time limits.';
$strTimeoutPassed = 'Superato il tempo limite dello script, se vuoi finire l\'importazione inoltra nuovamente il file e il processo riprender&agrave;.';
$strTime = 'Tempo';
...
$strTransformation_application_octetstream__download = 'Visualizza un collegamento per trasferire i dati di un campo in formato binario.  La prima opzione &egrave; il nome del file binario.  La seconda opzione &egrave; un nome di campo possibile di una riga della tabella che contiene il nome di schedario.  Se fornite una seconda opzione dovete avere la prima opzione settata ad una stringa vuota';
...
$strTransformation_text_plain__dateformat = 'Mostra i campi TIME, TIMESTAMP, DATETIME o il TIMESTAMP UNIX come data formattata. La prima opzione &egrave; l\'offset (in ore) che verr&agrave; aggiunto all\'ora (Default: 0). Usare la seconda opzione per specificare un differente formato di data/ora. La terza opzione determina se vuoi vedere l\'ora locale o UTC (usa "local" o "utc" per questo). In relazione a questo, il formato data ha differenti valori - per "local" guarda la documentazione della funzione PHP strftime(); per "utc" viene usata la funzione gmdate().';
$strTransformation_text_plain__external = 'SOLO PER LINUX: Lancia un\'applicazione esterna e riempie i dati dei campi tramite lo standard input. Restituisce lo standard output dell\'applicazione. L\'impostazione predefinita &egrave; Tidy, per stampare in maniera corretta il codice HTML. Per motivi di sicurezza, dovete editare manualmente il file libraries/transformations/text_plain__external.inc.php e inserire gli strumenti che permettete di utilizzare. La prima opzione &egrave; cos&igrave; il numero del programma che volete utilizzare e la seconda sono i parametri per il programma. Il terzo parametro, se impostato a 1 convertir&agrave; l\'output utilizzando htmlspecialchars() (Predefinito: 1). Un quarto parametro, se impostato a 1 inserir&agrave; un NOWRAP al contenuto della cella cos&igrave; che l\'intero output sar&agrave; mostrato senza essere riformattato (Predefinito: 1)';
$strTransformation_text_plain__formatted = 'Preserva l\'originale formattazione del campo. Nessun Escaping viene applicato.';
$strTransformation_text_plain__imagelink = 'Mostra un collegamento ad una immagine esterna; il campo contiene il nome del file; la prima opzione &egrave; un prefisso come "http://tuodominio.com/", la seconda opzione &egrave; la larghezza in pixel, la terza &egrave; l\'altezza.';
$strTransformation_text_plain__link = 'Mostra un collegamento, il campo contiene il nome del file; la prima opzione &egrave; un prefisso come "http://tuodominio.com/", la seconda opzione &egrave; un titolo per il collegamento.';
$strTransformation_text_plain__sql = 'Formatta il testo come query SQL con evidenziazione della sintassi.';
$strTransformation_text_plain__substr = 'Mostra soltanto una parte della stringa. La prima opzione &egrave; l\'offset che serve a definire dove inizia l\'output del vostro testo (Prefinito: 0). La seconda opzione &egrave; un offset che indica quanto testo viene restituito. Se vuoto, restituisce tutto il testo rimanente. La terza opzione definisce quali caratteri saranno aggiunti in fondo all\'output quando una soptto-stringa viene restituita (Predefinito: ...) .';
...
$strUnsupportedCompressionDetected = 'Stai cercando di importare un file con un tipo di compressione non supportato. Altrimenti il supporto per questo tipo di compressione non &egrave; stato ancora implementato o &egrave; stato disabilitato dalla tua configurazione.';
...
$strUploadErrorPartial = 'Il file &egrave; stato solo parzialmente caricato.';
...
$strUploadsNotAllowed = 'Non &egrave; permesso l\'upload dei file su questo server.';
$strUsage = 'Utilizzo';
$strUseBackquotes = 'Usa i backquotes con i nomi delle tabelle e dei campi';
$strUseHostTable = 'Utilizza la Tabella dell\'Host';
$strUserAlreadyExists = 'L\'utente %s esiste gi&agrave;!';
$strUserEmpty = 'Il nome utente &egrave; vuoto!';
$strUserName = 'Nome utente';
$strUserNotFound = 'L\'utente selezionato non &egrave; stato trovato nella tabella dei privilegi.';
...
$strValidatorError = 'L\' SQL validator non pu&ograve; essere inizializzato. Prego controllare di avere installato le estensioni php necessarie come descritto nella %sdocumentazione%s.';
$strValue = 'Valore';
$strVar = 'Variabile';
...
$strViewHasBeenDropped = 'La vista %s &egrave; stata eliminata';
$strViewName = 'Nome VISTA';
$strView = 'Vista';

$strWebServerUploadDirectory = 'directory di upload del web-server';
$strWebServerUploadDirectoryError = 'La directory impostata per l\'upload non pu&ograve; essere trovata';
$strWebServer = 'Web server';
$strWelcome = 'Benvenuto in %s';
$strWestEuropean = 'Europeo Occidentale';
$strWiki = 'Wiki';
$strWildcard = 'wildcard';
$strWindowNotFound = 'La finestra destinataria del browser non pu&ograve; essere aggiornata. Pu&ograve; darsi che sia stata chiusa la finestra madre o che il vostro browser stia bloccando gli aggiornamenti fra browsers a causa di qualche impostazione di sicurezza';
