            ...
            <td>
			  <table width="100%" align="left" cellpadding="5" cellspacing="5">
                ...
                <tr>
                  ...
                  <td width="60" class="{CLASS}" nowrap align="center">
				  <img src="{THEME_COLOR_PATH}/images/icons/edit.gif" width="18" height="18" border="0" align="absmiddle"> <a href="protect_it.php?id={PID}" class="link">{TR_EDIT}</a> </td>
