...
document.f.smallcal_hexval.value = val;
}
//  End -->
</script>

<?php echo _("Color Picker") ?><br>
<map name="colmap">
...
<a><img usemap="#colmap" src="../plugins/smallcal/colortable.gif" border=0 width=289 height=67></a>
<br>
<?php echo _("Click a box and the hexadecimal color will be shown <br>below.
Use these hex values for color box settings.") ?><br><br>
<b><?php echo _("Hex Value") ?></b><br>
<input type=text name="smallcal_hexval" size=10 readonly>
