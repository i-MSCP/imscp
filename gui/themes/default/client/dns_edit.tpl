...
<form name="edit_dns_frm" method="post" action="{ACTION_MODE}">
	<table class="firstColFixed">
		...
		<tr id="tr_dns_ip_address">
			...
			<td>
				<input id="dns_A_address" type="text" onkeypress="return filterChars(event, IPADDRESS);" name="dns_A_address" value="{DNS_ADDRESS}" class="inputTitle">
			</td>
		</tr>
		<tr id="tr_dns_ip_address_v6">
			<td><label for="dns_AAAA_address">{TR_DNS_IP_ADDRESS_V6}</label></td>
			<td>
				<input id="dns_AAAA_address" type="text" onkeypress="return filterChars(event, IPv6ADDRESS);" name="dns_AAAA_address" value="{DNS_ADDRESS_V6}" class="inputTitle">
			</td>
		</tr>
		...
		<tr id="tr_dns_srv_weight">
			...
			<td>
				<input id="dns_srv_weight" type="number" min="0" max="65535" name="dns_srv_weight" value="{DNS_SRV_WEIGHT}">
			</td>
		</tr>
		...
		<tr id="tr_dns_srv_host">
			...
			<td>
				<input id="dns_srv_host" type="text" name="dns_srv_host" value="{DNS_SRV_HOST}" class="inputTitle">
			</td>
		</tr>
		<tr id="tr_dns_cname">
		...
		<tr id="tr_dns_txt_data">
			...
			<td><input id="dns_txt_data" type="text" name="dns_txt_data" value="{DNS_TXT_DATA}" class="inputTitle"></td>
		</tr>
		</tbody>
	</table>
	<div class="buttons">
