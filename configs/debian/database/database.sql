...
create table if not exists `autoreplies_log` (
  ...
  index `from` (`from`(191)),
  index `to` (`to`(191))
) engine=InnoDB character set utf8 comment = 'Sent autoreplies log table';
...
create table if not exists `web_software` (
  ...
  `reseller_id` int(10) unsigned not null default '0',
  `software_installtype` varchar(15) character set utf8 not null,
  `software_name` varchar(100) character set utf8 not null,
  `software_version` varchar(20) character set utf8 not null,
  `software_language` varchar(15) character set utf8 not null,
  `software_type` varchar(20) character set utf8 not null,
  `software_db` tinyint(1) not null,
  `software_archive` varchar(100) character set utf8 not null,
  `software_installfile` varchar(100) character set utf8 not null,
  `software_prefix` varchar(50) character set utf8 not null,
  `software_link` varchar(100) character set utf8 not null,
  `software_desc` mediumtext character set utf8 not null,
  `software_active` int(1) not null,
  `software_status` varchar(15) character set utf8 not null,
  `rights_add_by` int(10) unsigned not null default '0',
  `software_depot` varchar(15) character set utf8 not null not null default 'no',
...
create table if not exists `web_software_inst` (
  ...
  `software_prefix` varchar(50) character set utf8 not null default '0',
  `db` varchar(100) character set utf8 not null default '0',
  `database_user` varchar(100) character set utf8 not null default '0',
  `database_tmp_pwd` varchar(100) character set utf8 not null default '0',
  `install_username` varchar(100) character set utf8 not null default '0',
  `install_password` varchar(100) character set utf8 not null default '0',
  `install_email` varchar(100) character set utf8 not null default '0',
  `software_status` varchar(15) character set utf8 not null,
  `software_depot` varchar(15) character set utf8 not null not null default 'no',
  index `domain_id` (`domain_id`),
  index `alias_id` (`alias_id`),
...
create table if not exists `web_software_depot` (
  ...
  `package_description` mediumtext character set utf8 not null,
