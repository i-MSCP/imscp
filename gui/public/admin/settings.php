...
if (!empty($_POST)) {
    ...
    $protecttDefaultEmails = isset($_POST['protect_default_email_addresses']) ? clean_input($_POST['protect_default_email_addresses']) : $cfg['PROTECT_DEFAULT_EMAIL_ADDRESSES'];
