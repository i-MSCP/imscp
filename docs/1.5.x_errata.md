...
If you really want provide your own /etc/apt/sources.list file, you can always
make use of the [Listener::APT::Source::List](../contrib/Listeners/APT/10_apt_sources_list.pl)
